...
#ifndef _SIMPLE_CLIENT_SHELL_WRAPPER_H_
#define _SIMPLE_CLIENT_SHELL_WRAPPER_H_
...
ref class SimpleClientShell;

class Custom_shell : public Simple_shell_client
{
public:
  Custom_shell(gcroot<SimpleClientShell^> shell /* managed reference to  SimpleClientShell */) : Simple_shell_client(), _shell(shell) { }
  virtual ~Custom_shell() { _shell = nullptr; }
...
private:
  gcroot<SimpleClientShell^> _shell;
};
...
public ref class SimpleClientShell
{
public:
  SimpleClientShell();
