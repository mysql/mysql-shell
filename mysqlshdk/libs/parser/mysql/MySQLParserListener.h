...
public:
  ...
  virtual void enterAlterDatabaseOption(MySQLParser::AlterDatabaseOptionContext *ctx) = 0;
  virtual void exitAlterDatabaseOption(MySQLParser::AlterDatabaseOptionContext *ctx) = 0;
  ...
  virtual void enterViewQueryBlock(MySQLParser::ViewQueryBlockContext *ctx) = 0;
  virtual void exitViewQueryBlock(MySQLParser::ViewQueryBlockContext *ctx) = 0;
  ...
  virtual void enterAlterInstanceStatement(MySQLParser::AlterInstanceStatementContext *ctx) = 0;
  virtual void exitAlterInstanceStatement(MySQLParser::AlterInstanceStatementContext *ctx) = 0;
  ...
  virtual void enterTsOptionEngineAttribute(MySQLParser::TsOptionEngineAttributeContext *ctx) = 0;
  virtual void exitTsOptionEngineAttribute(MySQLParser::TsOptionEngineAttributeContext *ctx) = 0;
  ...
  virtual void enterQueryPrimary(MySQLParser::QueryPrimaryContext *ctx) = 0;
  virtual void exitQueryPrimary(MySQLParser::QueryPrimaryContext *ctx) = 0;
  ...
  virtual void enterTableValueConstructor(MySQLParser::TableValueConstructorContext *ctx) = 0;
  virtual void exitTableValueConstructor(MySQLParser::TableValueConstructorContext *ctx) = 0;

  virtual void enterExplicitTable(MySQLParser::ExplicitTableContext *ctx) = 0;
  virtual void exitExplicitTable(MySQLParser::ExplicitTableContext *ctx) = 0;

  virtual void enterRowValueExplicit(MySQLParser::RowValueExplicitContext *ctx) = 0;
  virtual void exitRowValueExplicit(MySQLParser::RowValueExplicitContext *ctx) = 0;
  ...
  virtual void enterLockingClauseList(MySQLParser::LockingClauseListContext *ctx) = 0;
  virtual void exitLockingClauseList(MySQLParser::LockingClauseListContext *ctx) = 0;
  ...
  virtual void enterOnEmptyOrErrorJsonTable(MySQLParser::OnEmptyOrErrorJsonTableContext *ctx) = 0;
  virtual void exitOnEmptyOrErrorJsonTable(MySQLParser::OnEmptyOrErrorJsonTableContext *ctx) = 0;
  ...
  virtual void enterJsonOnResponse(MySQLParser::JsonOnResponseContext *ctx) = 0;
  virtual void exitJsonOnResponse(MySQLParser::JsonOnResponseContext *ctx) = 0;
  ...
  virtual void enterStartTransactionOptionList(MySQLParser::StartTransactionOptionListContext *ctx) = 0;
  virtual void exitStartTransactionOptionList(MySQLParser::StartTransactionOptionListContext *ctx) = 0;
  ...
  virtual void enterSourceDefinition(MySQLParser::SourceDefinitionContext *ctx) = 0;
  virtual void exitSourceDefinition(MySQLParser::SourceDefinitionContext *ctx) = 0;

  virtual void enterChangeReplicationSourceAutoPosition(MySQLParser::ChangeReplicationSourceAutoPositionContext *ctx) = 0;
  virtual void exitChangeReplicationSourceAutoPosition(MySQLParser::ChangeReplicationSourceAutoPositionContext *ctx) = 0;

  virtual void enterChangeReplicationSourceHost(MySQLParser::ChangeReplicationSourceHostContext *ctx) = 0;
  virtual void exitChangeReplicationSourceHost(MySQLParser::ChangeReplicationSourceHostContext *ctx) = 0;

  virtual void enterChangeReplicationSourceBind(MySQLParser::ChangeReplicationSourceBindContext *ctx) = 0;
  virtual void exitChangeReplicationSourceBind(MySQLParser::ChangeReplicationSourceBindContext *ctx) = 0;

  virtual void enterChangeReplicationSourceUser(MySQLParser::ChangeReplicationSourceUserContext *ctx) = 0;
  virtual void exitChangeReplicationSourceUser(MySQLParser::ChangeReplicationSourceUserContext *ctx) = 0;

  virtual void enterChangeReplicationSourcePassword(MySQLParser::ChangeReplicationSourcePasswordContext *ctx) = 0;
  virtual void exitChangeReplicationSourcePassword(MySQLParser::ChangeReplicationSourcePasswordContext *ctx) = 0;

  virtual void enterChangeReplicationSourcePort(MySQLParser::ChangeReplicationSourcePortContext *ctx) = 0;
  virtual void exitChangeReplicationSourcePort(MySQLParser::ChangeReplicationSourcePortContext *ctx) = 0;

  virtual void enterChangeReplicationSourceConnectRetry(MySQLParser::ChangeReplicationSourceConnectRetryContext *ctx) = 0;
  virtual void exitChangeReplicationSourceConnectRetry(MySQLParser::ChangeReplicationSourceConnectRetryContext *ctx) = 0;

  virtual void enterChangeReplicationSourceRetryCount(MySQLParser::ChangeReplicationSourceRetryCountContext *ctx) = 0;
  virtual void exitChangeReplicationSourceRetryCount(MySQLParser::ChangeReplicationSourceRetryCountContext *ctx) = 0;

  virtual void enterChangeReplicationSourceDelay(MySQLParser::ChangeReplicationSourceDelayContext *ctx) = 0;
  virtual void exitChangeReplicationSourceDelay(MySQLParser::ChangeReplicationSourceDelayContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSL(MySQLParser::ChangeReplicationSourceSSLContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSL(MySQLParser::ChangeReplicationSourceSSLContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLCA(MySQLParser::ChangeReplicationSourceSSLCAContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLCA(MySQLParser::ChangeReplicationSourceSSLCAContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLCApath(MySQLParser::ChangeReplicationSourceSSLCApathContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLCApath(MySQLParser::ChangeReplicationSourceSSLCApathContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLCipher(MySQLParser::ChangeReplicationSourceSSLCipherContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLCipher(MySQLParser::ChangeReplicationSourceSSLCipherContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLCLR(MySQLParser::ChangeReplicationSourceSSLCLRContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLCLR(MySQLParser::ChangeReplicationSourceSSLCLRContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLCLRpath(MySQLParser::ChangeReplicationSourceSSLCLRpathContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLCLRpath(MySQLParser::ChangeReplicationSourceSSLCLRpathContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLKey(MySQLParser::ChangeReplicationSourceSSLKeyContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLKey(MySQLParser::ChangeReplicationSourceSSLKeyContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLVerifyServerCert(MySQLParser::ChangeReplicationSourceSSLVerifyServerCertContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLVerifyServerCert(MySQLParser::ChangeReplicationSourceSSLVerifyServerCertContext *ctx) = 0;

  virtual void enterChangeReplicationSourceTLSVersion(MySQLParser::ChangeReplicationSourceTLSVersionContext *ctx) = 0;
  virtual void exitChangeReplicationSourceTLSVersion(MySQLParser::ChangeReplicationSourceTLSVersionContext *ctx) = 0;

  virtual void enterChangeReplicationSourceTLSCiphersuites(MySQLParser::ChangeReplicationSourceTLSCiphersuitesContext *ctx) = 0;
  virtual void exitChangeReplicationSourceTLSCiphersuites(MySQLParser::ChangeReplicationSourceTLSCiphersuitesContext *ctx) = 0;

  virtual void enterChangeReplicationSourceSSLCert(MySQLParser::ChangeReplicationSourceSSLCertContext *ctx) = 0;
  virtual void exitChangeReplicationSourceSSLCert(MySQLParser::ChangeReplicationSourceSSLCertContext *ctx) = 0;

  virtual void enterChangeReplicationSourcePublicKey(MySQLParser::ChangeReplicationSourcePublicKeyContext *ctx) = 0;
  virtual void exitChangeReplicationSourcePublicKey(MySQLParser::ChangeReplicationSourcePublicKeyContext *ctx) = 0;

  virtual void enterChangeReplicationSourceGetSourcePublicKey(MySQLParser::ChangeReplicationSourceGetSourcePublicKeyContext *ctx) = 0;
  virtual void exitChangeReplicationSourceGetSourcePublicKey(MySQLParser::ChangeReplicationSourceGetSourcePublicKeyContext *ctx) = 0;

  virtual void enterChangeReplicationSourceHeartbeatPeriod(MySQLParser::ChangeReplicationSourceHeartbeatPeriodContext *ctx) = 0;
  virtual void exitChangeReplicationSourceHeartbeatPeriod(MySQLParser::ChangeReplicationSourceHeartbeatPeriodContext *ctx) = 0;

  virtual void enterChangeReplicationSourceCompressionAlgorithm(MySQLParser::ChangeReplicationSourceCompressionAlgorithmContext *ctx) = 0;
  virtual void exitChangeReplicationSourceCompressionAlgorithm(MySQLParser::ChangeReplicationSourceCompressionAlgorithmContext *ctx) = 0;

  virtual void enterChangeReplicationSourceZstdCompressionLevel(MySQLParser::ChangeReplicationSourceZstdCompressionLevelContext *ctx) = 0;
  virtual void exitChangeReplicationSourceZstdCompressionLevel(MySQLParser::ChangeReplicationSourceZstdCompressionLevelContext *ctx) = 0;
  ...
  virtual void enterTablePrimaryKeyCheckDef(MySQLParser::TablePrimaryKeyCheckDefContext *ctx) = 0;
  virtual void exitTablePrimaryKeyCheckDef(MySQLParser::TablePrimaryKeyCheckDefContext *ctx) = 0;

  virtual void enterAssignGtidsToAnonymousTransactionsDefinition(MySQLParser::AssignGtidsToAnonymousTransactionsDefinitionContext *ctx) = 0;
  virtual void exitAssignGtidsToAnonymousTransactionsDefinition(MySQLParser::AssignGtidsToAnonymousTransactionsDefinitionContext *ctx) = 0;

  virtual void enterSourceTlsCiphersuitesDef(MySQLParser::SourceTlsCiphersuitesDefContext *ctx) = 0;
  virtual void exitSourceTlsCiphersuitesDef(MySQLParser::SourceTlsCiphersuitesDefContext *ctx) = 0;

  virtual void enterSourceFileDef(MySQLParser::SourceFileDefContext *ctx) = 0;
  virtual void exitSourceFileDef(MySQLParser::SourceFileDefContext *ctx) = 0;

  virtual void enterSourceLogFile(MySQLParser::SourceLogFileContext *ctx) = 0;
  virtual void exitSourceLogFile(MySQLParser::SourceLogFileContext *ctx) = 0;

  virtual void enterSourceLogPos(MySQLParser::SourceLogPosContext *ctx) = 0;
  virtual void exitSourceLogPos(MySQLParser::SourceLogPosContext *ctx) = 0;
  ...
  virtual void enterStartReplicaStatement(MySQLParser::StartReplicaStatementContext *ctx) = 0;
  virtual void exitStartReplicaStatement(MySQLParser::StartReplicaStatementContext *ctx) = 0;

  virtual void enterStopReplicaStatement(MySQLParser::StopReplicaStatementContext *ctx) = 0;
  virtual void exitStopReplicaStatement(MySQLParser::StopReplicaStatementContext *ctx) = 0;

  virtual void enterReplicaUntil(MySQLParser::ReplicaUntilContext *ctx) = 0;
  virtual void exitReplicaUntil(MySQLParser::ReplicaUntilContext *ctx) = 0;

  virtual void enterUserOption(MySQLParser::UserOptionContext *ctx) = 0;
  virtual void exitUserOption(MySQLParser::UserOptionContext *ctx) = 0;

  virtual void enterPasswordOption(MySQLParser::PasswordOptionContext *ctx) = 0;
  virtual void exitPasswordOption(MySQLParser::PasswordOptionContext *ctx) = 0;

  virtual void enterDefaultAuthOption(MySQLParser::DefaultAuthOptionContext *ctx) = 0;
  virtual void exitDefaultAuthOption(MySQLParser::DefaultAuthOptionContext *ctx) = 0;

  virtual void enterPluginDirOption(MySQLParser::PluginDirOptionContext *ctx) = 0;
  virtual void exitPluginDirOption(MySQLParser::PluginDirOptionContext *ctx) = 0;

  virtual void enterReplicaThreadOptions(MySQLParser::ReplicaThreadOptionsContext *ctx) = 0;
  virtual void exitReplicaThreadOptions(MySQLParser::ReplicaThreadOptionsContext *ctx) = 0;

  virtual void enterReplicaThreadOption(MySQLParser::ReplicaThreadOptionContext *ctx) = 0;
  virtual void exitReplicaThreadOption(MySQLParser::ReplicaThreadOptionContext *ctx) = 0;
  ...
  virtual void enterGroupReplicationStartOptions(MySQLParser::GroupReplicationStartOptionsContext *ctx) = 0;
  virtual void exitGroupReplicationStartOptions(MySQLParser::GroupReplicationStartOptionsContext *ctx) = 0;

  virtual void enterGroupReplicationStartOption(MySQLParser::GroupReplicationStartOptionContext *ctx) = 0;
  virtual void exitGroupReplicationStartOption(MySQLParser::GroupReplicationStartOptionContext *ctx) = 0;

  virtual void enterGroupReplicationUser(MySQLParser::GroupReplicationUserContext *ctx) = 0;
  virtual void exitGroupReplicationUser(MySQLParser::GroupReplicationUserContext *ctx) = 0;

  virtual void enterGroupReplicationPassword(MySQLParser::GroupReplicationPasswordContext *ctx) = 0;
  virtual void exitGroupReplicationPassword(MySQLParser::GroupReplicationPasswordContext *ctx) = 0;

  virtual void enterGroupReplicationPluginAuth(MySQLParser::GroupReplicationPluginAuthContext *ctx) = 0;
  virtual void exitGroupReplicationPluginAuth(MySQLParser::GroupReplicationPluginAuthContext *ctx) = 0;

  virtual void enterReplica(MySQLParser::ReplicaContext *ctx) = 0;
  virtual void exitReplica(MySQLParser::ReplicaContext *ctx) = 0;
  ...
  virtual void enterAlterUserStatement(MySQLParser::AlterUserStatementContext *ctx) = 0;
  virtual void exitAlterUserStatement(MySQLParser::AlterUserStatementContext *ctx) = 0;
  ...
  virtual void enterOldAlterUser(MySQLParser::OldAlterUserContext *ctx) = 0;
  virtual void exitOldAlterUser(MySQLParser::OldAlterUserContext *ctx) = 0;
  ...
  virtual void enterCreateUserStatement(MySQLParser::CreateUserStatementContext *ctx) = 0;
  virtual void exitCreateUserStatement(MySQLParser::CreateUserStatementContext *ctx) = 0;
  ...
  virtual void enterUserAttributes(MySQLParser::UserAttributesContext *ctx) = 0;
  virtual void exitUserAttributes(MySQLParser::UserAttributesContext *ctx) = 0;
  ...
  virtual void enterDropUserStatement(MySQLParser::DropUserStatementContext *ctx) = 0;
  virtual void exitDropUserStatement(MySQLParser::DropUserStatementContext *ctx) = 0;
  ...
  virtual void enterRenameUserStatement(MySQLParser::RenameUserStatementContext *ctx) = 0;
  virtual void exitRenameUserStatement(MySQLParser::RenameUserStatementContext *ctx) = 0;
  ...
  virtual void enterSetRoleStatement(MySQLParser::SetRoleStatementContext *ctx) = 0;
  virtual void exitSetRoleStatement(MySQLParser::SetRoleStatementContext *ctx) = 0;
  ...
  virtual void enterShowDatabasesStatement(MySQLParser::ShowDatabasesStatementContext *ctx) = 0;
  virtual void exitShowDatabasesStatement(MySQLParser::ShowDatabasesStatementContext *ctx) = 0;

  virtual void enterShowTablesStatement(MySQLParser::ShowTablesStatementContext *ctx) = 0;
  virtual void exitShowTablesStatement(MySQLParser::ShowTablesStatementContext *ctx) = 0;

  virtual void enterShowTriggersStatement(MySQLParser::ShowTriggersStatementContext *ctx) = 0;
  virtual void exitShowTriggersStatement(MySQLParser::ShowTriggersStatementContext *ctx) = 0;

  virtual void enterShowEventsStatement(MySQLParser::ShowEventsStatementContext *ctx) = 0;
  virtual void exitShowEventsStatement(MySQLParser::ShowEventsStatementContext *ctx) = 0;

  virtual void enterShowTableStatusStatement(MySQLParser::ShowTableStatusStatementContext *ctx) = 0;
  virtual void exitShowTableStatusStatement(MySQLParser::ShowTableStatusStatementContext *ctx) = 0;
  ...
  virtual void enterShowEngineLogsStatement(MySQLParser::ShowEngineLogsStatementContext *ctx) = 0;
  virtual void exitShowEngineLogsStatement(MySQLParser::ShowEngineLogsStatementContext *ctx) = 0;

  virtual void enterShowEngineMutexStatement(MySQLParser::ShowEngineMutexStatementContext *ctx) = 0;
  virtual void exitShowEngineMutexStatement(MySQLParser::ShowEngineMutexStatementContext *ctx) = 0;

  virtual void enterShowEngineStatusStatement(MySQLParser::ShowEngineStatusStatementContext *ctx) = 0;
  virtual void exitShowEngineStatusStatement(MySQLParser::ShowEngineStatusStatementContext *ctx) = 0;

  virtual void enterShowColumnsStatement(MySQLParser::ShowColumnsStatementContext *ctx) = 0;
  virtual void exitShowColumnsStatement(MySQLParser::ShowColumnsStatementContext *ctx) = 0;
  ...
  virtual void enterShowBinlogEventsStatement(MySQLParser::ShowBinlogEventsStatementContext *ctx) = 0;
  virtual void exitShowBinlogEventsStatement(MySQLParser::ShowBinlogEventsStatementContext *ctx) = 0;

  virtual void enterShowRelaylogEventsStatement(MySQLParser::ShowRelaylogEventsStatementContext *ctx) = 0;
  virtual void exitShowRelaylogEventsStatement(MySQLParser::ShowRelaylogEventsStatementContext *ctx) = 0;

  virtual void enterShowKeysStatement(MySQLParser::ShowKeysStatementContext *ctx) = 0;
  virtual void exitShowKeysStatement(MySQLParser::ShowKeysStatementContext *ctx) = 0;

  virtual void enterShowEnginesStatement(MySQLParser::ShowEnginesStatementContext *ctx) = 0;
  virtual void exitShowEnginesStatement(MySQLParser::ShowEnginesStatementContext *ctx) = 0;

  virtual void enterShowCountWarningsStatement(MySQLParser::ShowCountWarningsStatementContext *ctx) = 0;
  virtual void exitShowCountWarningsStatement(MySQLParser::ShowCountWarningsStatementContext *ctx) = 0;

  virtual void enterShowCountErrorsStatement(MySQLParser::ShowCountErrorsStatementContext *ctx) = 0;
  virtual void exitShowCountErrorsStatement(MySQLParser::ShowCountErrorsStatementContext *ctx) = 0;

  virtual void enterShowWarningsStatement(MySQLParser::ShowWarningsStatementContext *ctx) = 0;
  virtual void exitShowWarningsStatement(MySQLParser::ShowWarningsStatementContext *ctx) = 0;

  virtual void enterShowErrorsStatement(MySQLParser::ShowErrorsStatementContext *ctx) = 0;
  virtual void exitShowErrorsStatement(MySQLParser::ShowErrorsStatementContext *ctx) = 0;

  virtual void enterShowProfilesStatement(MySQLParser::ShowProfilesStatementContext *ctx) = 0;
  virtual void exitShowProfilesStatement(MySQLParser::ShowProfilesStatementContext *ctx) = 0;

  virtual void enterShowProfileStatement(MySQLParser::ShowProfileStatementContext *ctx) = 0;
  virtual void exitShowProfileStatement(MySQLParser::ShowProfileStatementContext *ctx) = 0;

  virtual void enterShowStatusStatement(MySQLParser::ShowStatusStatementContext *ctx) = 0;
  virtual void exitShowStatusStatement(MySQLParser::ShowStatusStatementContext *ctx) = 0;

  virtual void enterShowProcessListStatement(MySQLParser::ShowProcessListStatementContext *ctx) = 0;
  virtual void exitShowProcessListStatement(MySQLParser::ShowProcessListStatementContext *ctx) = 0;

  virtual void enterShowVariablesStatement(MySQLParser::ShowVariablesStatementContext *ctx) = 0;
  virtual void exitShowVariablesStatement(MySQLParser::ShowVariablesStatementContext *ctx) = 0;

  virtual void enterShowCharacterSetStatement(MySQLParser::ShowCharacterSetStatementContext *ctx) = 0;
  virtual void exitShowCharacterSetStatement(MySQLParser::ShowCharacterSetStatementContext *ctx) = 0;

  virtual void enterShowCollationStatement(MySQLParser::ShowCollationStatementContext *ctx) = 0;
  virtual void exitShowCollationStatement(MySQLParser::ShowCollationStatementContext *ctx) = 0;

  virtual void enterShowPrivilegesStatement(MySQLParser::ShowPrivilegesStatementContext *ctx) = 0;
  virtual void exitShowPrivilegesStatement(MySQLParser::ShowPrivilegesStatementContext *ctx) = 0;

  virtual void enterShowGrantsStatement(MySQLParser::ShowGrantsStatementContext *ctx) = 0;
  virtual void exitShowGrantsStatement(MySQLParser::ShowGrantsStatementContext *ctx) = 0;

  virtual void enterShowCreateDatabaseStatement(MySQLParser::ShowCreateDatabaseStatementContext *ctx) = 0;
  virtual void exitShowCreateDatabaseStatement(MySQLParser::ShowCreateDatabaseStatementContext *ctx) = 0;

  virtual void enterShowCreateTableStatement(MySQLParser::ShowCreateTableStatementContext *ctx) = 0;
  virtual void exitShowCreateTableStatement(MySQLParser::ShowCreateTableStatementContext *ctx) = 0;

  virtual void enterShowCreateViewStatement(MySQLParser::ShowCreateViewStatementContext *ctx) = 0;
  virtual void exitShowCreateViewStatement(MySQLParser::ShowCreateViewStatementContext *ctx) = 0;

  virtual void enterShowMasterStatusStatement(MySQLParser::ShowMasterStatusStatementContext *ctx) = 0;
  virtual void exitShowMasterStatusStatement(MySQLParser::ShowMasterStatusStatementContext *ctx) = 0;

  virtual void enterShowReplicaStatusStatement(MySQLParser::ShowReplicaStatusStatementContext *ctx) = 0;
  virtual void exitShowReplicaStatusStatement(MySQLParser::ShowReplicaStatusStatementContext *ctx) = 0;

  virtual void enterShowCreateProcedureStatement(MySQLParser::ShowCreateProcedureStatementContext *ctx) = 0;
  virtual void exitShowCreateProcedureStatement(MySQLParser::ShowCreateProcedureStatementContext *ctx) = 0;
  ...
  virtual void enterShowCreateUserStatement(MySQLParser::ShowCreateUserStatementContext *ctx) = 0;
  virtual void exitShowCreateUserStatement(MySQLParser::ShowCreateUserStatementContext *ctx) = 0;
  ...
  virtual void enterEngineOrAll(MySQLParser::EngineOrAllContext *ctx) = 0;
  virtual void exitEngineOrAll(MySQLParser::EngineOrAllContext *ctx) = 0;
  ...
  virtual void enterProfileDefinitions(MySQLParser::ProfileDefinitionsContext *ctx) = 0;
  virtual void exitProfileDefinitions(MySQLParser::ProfileDefinitionsContext *ctx) = 0;

  virtual void enterProfileDefinition(MySQLParser::ProfileDefinitionContext *ctx) = 0;
  virtual void exitProfileDefinition(MySQLParser::ProfileDefinitionContext *ctx) = 0;
  ...
  virtual void enterDescribeStatement(MySQLParser::DescribeStatementContext *ctx) = 0;
  virtual void exitDescribeStatement(MySQLParser::DescribeStatementContext *ctx) = 0;
  ...
  virtual void enterSimpleExpressionRValue(MySQLParser::SimpleExpressionRValueContext *ctx) = 0;
  virtual void exitSimpleExpressionRValue(MySQLParser::SimpleExpressionRValueContext *ctx) = 0;
  ...
  virtual void enterSimpleExprCastTime(MySQLParser::SimpleExprCastTimeContext *ctx) = 0;
  virtual void exitSimpleExprCastTime(MySQLParser::SimpleExprCastTimeContext *ctx) = 0;
  ...
  virtual void enterSimpleExprUserVariableAssignment(MySQLParser::SimpleExprUserVariableAssignmentContext *ctx) = 0;
  virtual void exitSimpleExprUserVariableAssignment(MySQLParser::SimpleExprUserVariableAssignmentContext *ctx) = 0;
  ...
  virtual void enterStableInteger(MySQLParser::StableIntegerContext *ctx) = 0;
  virtual void exitStableInteger(MySQLParser::StableIntegerContext *ctx) = 0;

  virtual void enterParamOrVar(MySQLParser::ParamOrVarContext *ctx) = 0;
  virtual void exitParamOrVar(MySQLParser::ParamOrVarContext *ctx) = 0;
  ...
  virtual void enterReturningType(MySQLParser::ReturningTypeContext *ctx) = 0;
  virtual void exitReturningType(MySQLParser::ReturningTypeContext *ctx) = 0;
  ...
  virtual void enterUserVariableIdentifier(MySQLParser::UserVariableIdentifierContext *ctx) = 0;
  virtual void exitUserVariableIdentifier(MySQLParser::UserVariableIdentifierContext *ctx) = 0;

  virtual void enterInExpressionUserVariableAssignment(MySQLParser::InExpressionUserVariableAssignmentContext *ctx) = 0;
  virtual void exitInExpressionUserVariableAssignment(MySQLParser::InExpressionUserVariableAssignmentContext *ctx) = 0;

  virtual void enterRvalueSystemOrUserVariable(MySQLParser::RvalueSystemOrUserVariableContext *ctx) = 0;
  virtual void exitRvalueSystemOrUserVariable(MySQLParser::RvalueSystemOrUserVariableContext *ctx) = 0;

  virtual void enterLvalueVariable(MySQLParser::LvalueVariableContext *ctx) = 0;
  virtual void exitLvalueVariable(MySQLParser::LvalueVariableContext *ctx) = 0;

  virtual void enterRvalueSystemVariable(MySQLParser::RvalueSystemVariableContext *ctx) = 0;
  virtual void exitRvalueSystemVariable(MySQLParser::RvalueSystemVariableContext *ctx) = 0;
  ...
  virtual void enterGetDiagnosticsStatement(MySQLParser::GetDiagnosticsStatementContext *ctx) = 0;
  virtual void exitGetDiagnosticsStatement(MySQLParser::GetDiagnosticsStatementContext *ctx) = 0;
  ...
  virtual void enterNow(MySQLParser::NowContext *ctx) = 0;
  virtual void exitNow(MySQLParser::NowContext *ctx) = 0;

  virtual void enterNowOrSignedLiteral(MySQLParser::NowOrSignedLiteralContext *ctx) = 0;
  virtual void exitNowOrSignedLiteral(MySQLParser::NowOrSignedLiteralContext *ctx) = 0;
  ...
  virtual void enterFunctionDatetimePrecision(MySQLParser::FunctionDatetimePrecisionContext *ctx) = 0;
  virtual void exitFunctionDatetimePrecision(MySQLParser::FunctionDatetimePrecisionContext *ctx) = 0;
  ...
  virtual void enterCreateUserWithMfa(MySQLParser::CreateUserWithMfaContext *ctx) = 0;
  virtual void exitCreateUserWithMfa(MySQLParser::CreateUserWithMfaContext *ctx) = 0;

  virtual void enterIdentification(MySQLParser::IdentificationContext *ctx) = 0;
  virtual void exitIdentification(MySQLParser::IdentificationContext *ctx) = 0;

  virtual void enterIdentifiedByPassword(MySQLParser::IdentifiedByPasswordContext *ctx) = 0;
  virtual void exitIdentifiedByPassword(MySQLParser::IdentifiedByPasswordContext *ctx) = 0;

  virtual void enterIdentifiedByRandomPassword(MySQLParser::IdentifiedByRandomPasswordContext *ctx) = 0;
  virtual void exitIdentifiedByRandomPassword(MySQLParser::IdentifiedByRandomPasswordContext *ctx) = 0;

  virtual void enterIdentifiedWithPlugin(MySQLParser::IdentifiedWithPluginContext *ctx) = 0;
  virtual void exitIdentifiedWithPlugin(MySQLParser::IdentifiedWithPluginContext *ctx) = 0;

  virtual void enterIdentifiedWithPluginAsAuth(MySQLParser::IdentifiedWithPluginAsAuthContext *ctx) = 0;
  virtual void exitIdentifiedWithPluginAsAuth(MySQLParser::IdentifiedWithPluginAsAuthContext *ctx) = 0;

  virtual void enterIdentifiedWithPluginByPassword(MySQLParser::IdentifiedWithPluginByPasswordContext *ctx) = 0;
  virtual void exitIdentifiedWithPluginByPassword(MySQLParser::IdentifiedWithPluginByPasswordContext *ctx) = 0;

  virtual void enterIdentifiedWithPluginByRandomPassword(MySQLParser::IdentifiedWithPluginByRandomPasswordContext *ctx) = 0;
  virtual void exitIdentifiedWithPluginByRandomPassword(MySQLParser::IdentifiedWithPluginByRandomPasswordContext *ctx) = 0;

  virtual void enterInitialAuth(MySQLParser::InitialAuthContext *ctx) = 0;
  virtual void exitInitialAuth(MySQLParser::InitialAuthContext *ctx) = 0;
  ...
  virtual void enterUserRegistration(MySQLParser::UserRegistrationContext *ctx) = 0;
  virtual void exitUserRegistration(MySQLParser::UserRegistrationContext *ctx) = 0;

  virtual void enterFactor(MySQLParser::FactorContext *ctx) = 0;
  virtual void exitFactor(MySQLParser::FactorContext *ctx) = 0;
  ...
  virtual void enterSignedLiteralOrNull(MySQLParser::SignedLiteralOrNullContext *ctx) = 0;
  virtual void exitSignedLiteralOrNull(MySQLParser::SignedLiteralOrNullContext *ctx) = 0;

  virtual void enterLiteral(MySQLParser::LiteralContext *ctx) = 0;
  virtual void exitLiteral(MySQLParser::LiteralContext *ctx) = 0;

  virtual void enterLiteralOrNull(MySQLParser::LiteralOrNullContext *ctx) = 0;
  virtual void exitLiteralOrNull(MySQLParser::LiteralOrNullContext *ctx) = 0;

  virtual void enterNullAsLiteral(MySQLParser::NullAsLiteralContext *ctx) = 0;
  virtual void exitNullAsLiteral(MySQLParser::NullAsLiteralContext *ctx) = 0;
  ...
  virtual void enterInt64Literal(MySQLParser::Int64LiteralContext *ctx) = 0;
  virtual void exitInt64Literal(MySQLParser::Int64LiteralContext *ctx) = 0;
  ...
  virtual void enterRvalueSystemVariableType(MySQLParser::RvalueSystemVariableTypeContext *ctx) = 0;
  virtual void exitRvalueSystemVariableType(MySQLParser::RvalueSystemVariableTypeContext *ctx) = 0;
  ...
  virtual void enterJsonAttribute(MySQLParser::JsonAttributeContext *ctx) = 0;
  virtual void exitJsonAttribute(MySQLParser::JsonAttributeContext *ctx) = 0;
