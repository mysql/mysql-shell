...
create:
        ...
        | CREATE opt_unique INDEX_SYM ident key_alg ON_SYM table_ident
          {
        ...
        | CREATE fulltext INDEX_SYM ident init_key_options ON_SYM
          table_ident
          {
            if (add_create_index_prepare(Lex, $7))
              MYSQL_YYABORT;
          ...
          opt_index_lock_algorithm { }
        | CREATE spatial INDEX_SYM ident init_key_options ON_SYM
          table_ident
          {
            if (add_create_index_prepare(Lex, $7))
              MYSQL_YYABORT;
...
create_table_option:
        ...
        | ENCRYPTION_SYM opt_equal TEXT_STRING_sys
	  {
        ...
        | PACK_KEYS_SYM opt_equal DEFAULT_SYM
          {
        ...
        | STATS_AUTO_RECALC_SYM opt_equal DEFAULT_SYM
          {
        ...
        | STATS_PERSISTENT_SYM opt_equal DEFAULT_SYM
          {
            Lex->create_info.table_options&=
...
attribute:
        ...
        | not NULL_SYM { Lex->type|= NOT_NULL_FLAG; }
        | DEFAULT_SYM now_or_signed_literal { Lex->default_value=$2; }
...
delete_option:
        ...
        | SET DEFAULT_SYM { $$= FK_OPTION_DEFAULT;  }
        ;
...
alter_list_item:
        ...
        | ALTER opt_column field_ident SET DEFAULT_SYM signed_literal
          {
            LEX *lex=Lex;
