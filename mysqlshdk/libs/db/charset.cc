...
static const Charset_entry k_charsets_info[] = {
...
std::string charset_name_from_collation_id(uint32_t id) {
  ...
  for (size_t i = 0; i < sizeof(k_charsets_info) / sizeof(k_charsets_info[0]);
       ++i) {
    if (k_charsets_info[i].id == id) {
      result = k_charsets_info[i].name;
      break;
    }
  }
...
std::string collation_name_from_collation_id(uint32_t id) {
  ...
  for (size_t i = 0; i < sizeof(k_charsets_info) / sizeof(k_charsets_info[0]);
       ++i) {
    if (k_charsets_info[i].id == id) {
      result = k_charsets_info[i].collation;
      break;
    }
  }
...
uint32_t collation_id_from_collation_name(const std::string& collation_name) {
  ...
  for (size_t i = 0; i < sizeof(k_charsets_info) / sizeof(k_charsets_info[0]);
       ++i) {
    if (k_charsets_info[i].collation == collation_name) {
      result = k_charsets_info[i].id;
      break;
    }
  }
