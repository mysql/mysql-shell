...
namespace shcore {
  namespace server_registry_tests
  {
    ...
    TEST(Server_registry_test, merge_file)
    {
      ...
      Connection_options cs2 = sr->add_connection_options("app1", "host=192.168.56.20; port=3306; dbUser=admin; dbPassword=456; ssl_ca=mysslca; ssl_cert=mysslcert; ssl_key=mysslkey");
