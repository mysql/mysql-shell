...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Option 'extractOidTime' can not be empty.");

//@<> Enabling extractOidTime with no value
import_docs(["--convertBsonOid", "--extractOidTime"]);
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Option 'extractOidTime' is expected to be of type String, but is Bool");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find a string with 24 hexadecimal digits processing extended JSON for $oid at offset 16");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find ',' processing extended JSON for $timestamp at offset 85");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find \"t\" processing extended JSON for $timestamp at offset 71");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find \"i\" processing extended JSON for $timestamp at offset 86");

//@<> $timestamp with non numeric at t
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},timestamp:{$timestamp:{t:"1543388511", i:1}}});
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find a number processing extended JSON for $timestamp at offset 75");

//@<> $timestamp with non numeric at i
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},timestamp:{$timestamp:{t:1543388511, i:"1"}}});
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find a number processing extended JSON for $timestamp at offset 90");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find '}' processing extended JSON for $timestamp at offset 91");

//@<> $numberLong with non string value
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},long:{$numberLong:4522}});
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find an integer string processing extended JSON for $numberLong at offset 66");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find '}' processing extended JSON for $numberLong at offset 72");

//@<> $numberInt with non string value
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},int:{$numberInt:4522}});
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find an integer string processing extended JSON for $numberInt at offset 64");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find '}' processing extended JSON for $numberInt at offset 70");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find a numeric string processing extended JSON for $numberDecimal at offset 72");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find '}' processing extended JSON for $numberDecimal at offset 78");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find a string with 2 hexadecimal digits processing extended JSON for $binary at offset 95");
...
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find ',' processing extended JSON for $binary at offset 86");

//@<> $binary with non string $binary
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},"binaryData":{$binary:12345,$type:"00"}})
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find a string processing extended JSON for $binary at offset 68");

//@<> $regex with invalid $options
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},"regExpression":{$regex:"^some*",$options:"a"}})
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, invalid options found processing extended JSON for $regex at offset 68");

//@<> $regex with invalid $options: not string
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},"regExpression":{$regex:"^some*",$options:450}})
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find a string processing extended JSON for $regex at offset 90");

//@<> $regex with no $options
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},"regExpression":{$regex:"^some*"}})
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find ',' processing extended JSON for $regex at offset 78");

//@<> $regex with extra field
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},"regExpression":{$regex:"^some*",$options:"i",extra:1}})
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find '}' processing extended JSON for $regex at offset 93");

//@<> $regex with field different than $options
import_doc({_id:{$oid:"5bfe3d5ff6d2f36d067c6fea"},"regExpression":{$regex:"^some*",$weird:"i"}})
EXPECT_STDOUT_CONTAINS("ERROR: Util.importJson: Unexpected data, expected to find \"$options\" processing extended JSON for $regex at offset 79");
