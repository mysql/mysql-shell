...
||You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'whatever' at line 1

//@ Testing error sql logging from session object
||Unknown column 'whatever' in 'field list' (MySQL Error 1054)
