...
| user_column_name {{  | }}                                                                                                                                                                                                                    | id |
+---{{--|-}}-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+
| {"_id": "55cb9c666c522cafdb053a1a", "name": "Bedford", "geometry": {"type": "Polygon", "coordinates": [[[-73.94400504048726, 40.70196179219718], [-73.94220058705264, 40.7008906674677{{46|5}}], [-73.94193078816193, 40.70072523469547]]]}} |  1 |
+---{{--|-}}-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+
...
| doc {{  | }}                                                                                                                                                                                                                                 |
+---{{--|-}}-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| {"_id": "55cb9c666c522cafdb053a1a", "name": "Bedford", "geometry": {"type": "Polygon", "coordinates": [[[-73.94400504048726, 40.70196179219718], [-73.94220058705264, 40.7008906674677{{46|5}}], [-73.94193078816193, 40.70072523469547]]]}} |
+---{{--|-}}-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| Field         | Type | Null | Key | Default | Extra          |
+---------------+------+------+-----+---------+----------------+
| ident         | int  | NO   | PRI | NULL    | auto_increment |
| json_data     | json | YES  |     | NULL    |                |
| default_value | int  | NO   |     | 42      |                |
+---------------+------+------+-----+---------+----------------+
