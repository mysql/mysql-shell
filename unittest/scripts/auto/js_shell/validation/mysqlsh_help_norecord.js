...
?{}
  ...
  --import <file> <table> <col> or table in MySQL Server. Set file to - if you
  ...
  --ssl-key=<file_name>         The path to the SSL private key file in PEM
                                format.
  --ssl-cert=<file_name>        The path to the SSL public key certificate file
                                in PEM format.
  ...
  --ssl-cipher=<cipher_list>    The list of permissible encryption ciphers for
                                connections that use TLS protocols up through
                                TLSv1.2.
...
?{}
  --credential-store-helper=<h> Specifies the helper which is going to be used
