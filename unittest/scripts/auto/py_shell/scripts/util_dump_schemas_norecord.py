...
EXPECT_FAIL("ValueError", 'Wrong input number "xyz"', [types_schema], test_output_absolute, { "bytesPerChunk": "xyz" })
EXPECT_FAIL("ValueError", 'Wrong input number "1xyz"', [types_schema], test_output_absolute, { "bytesPerChunk": "1xyz" })
EXPECT_FAIL("ValueError", 'Wrong input number "2Mhz"', [types_schema], test_output_absolute, { "bytesPerChunk": "2Mhz" })
# WL13807-TSFR_3_532_3
EXPECT_FAIL("ValueError", 'Wrong input number "0.1k"', [types_schema], test_output_absolute, { "bytesPerChunk": "0.1k" })
EXPECT_FAIL("ValueError", 'Wrong input number "0,3M"', [types_schema], test_output_absolute, { "bytesPerChunk": "0,3M" })
EXPECT_FAIL("ValueError", 'Input number "-1G" cannot be negative', [types_schema], test_output_absolute, { "bytesPerChunk": "-1G" })
EXPECT_FAIL("ValueError", "The option 'bytesPerChunk' cannot be set to an empty string.", [types_schema], test_output_absolute, { "bytesPerChunk": "" })
# WL13807-TSFR_3_532_2
EXPECT_FAIL("ValueError", "The option 'bytesPerChunk' cannot be used if the 'chunking' option is set to false.", [types_schema], test_output_absolute, { "bytesPerChunk": "128k", "chunking": False })
...
EXPECT_FAIL("ValueError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "127k" })
EXPECT_FAIL("ValueError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "127999" })
EXPECT_FAIL("ValueError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "1" })
EXPECT_FAIL("ValueError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "0" })
EXPECT_FAIL("ValueError", 'Input number "-1" cannot be negative', [types_schema], test_output_relative, { "bytesPerChunk": "-1" })
...
# WL13807-TSFR_3_54
EXPECT_FAIL("ValueError", "The value of 'threads' option must be greater than 0.", [types_schema], test_output_relative, { "threads": 0 })
...
EXPECT_FAIL("ValueError", 'Wrong input number "xyz"', [types_schema], test_output_absolute, { "maxRate": "xyz" })
EXPECT_FAIL("ValueError", 'Wrong input number "1xyz"', [types_schema], test_output_absolute, { "maxRate": "1xyz" })
EXPECT_FAIL("ValueError", 'Wrong input number "2Mhz"', [types_schema], test_output_absolute, { "maxRate": "2Mhz" })
# WL13807-TSFR_3_552
EXPECT_FAIL("ValueError", 'Wrong input number "hello world!"', [types_schema], test_output_absolute, { "maxRate": "hello world!" })
EXPECT_FAIL("ValueError", 'Input number "-1" cannot be negative', [types_schema], test_output_absolute, { "maxRate": "-1" })
EXPECT_FAIL("ValueError", 'Input number "-1234567890123456" cannot be negative', [types_schema], test_output_absolute, { "maxRate": "-1234567890123456" })
EXPECT_FAIL("ValueError", 'Input number "-2K" cannot be negative', [types_schema], test_output_absolute, { "maxRate": "-2K" })
EXPECT_FAIL("ValueError", 'Wrong input number "3m"', [types_schema], test_output_absolute, { "maxRate": "3m" })
EXPECT_FAIL("ValueError", 'Wrong input number "4g"', [types_schema], test_output_absolute, { "maxRate": "4g" })
...
EXPECT_FAIL("ValueError", "The option 'compression' cannot be set to an empty string.", [types_schema], test_output_relative, { "compression": "" })
EXPECT_FAIL("ValueError", "Unknown compression type: dummy", [types_schema], test_output_relative, { "compression": "dummy" })
...
EXPECT_FAIL("ValueError", "The option 'osNamespace' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "osNamespace": "namespace" })
...
# WL13807-TSFR_3_5102
EXPECT_FAIL("ValueError", "The option 'ociConfigFile' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "ociConfigFile": "config" })
...
EXPECT_FAIL("ValueError", "The option 'ociProfile' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "ociProfile": "profile" })
...
EXPECT_FAIL("ValueError", "The option 'ociParManifest' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "ociParManifest": True })
EXPECT_FAIL("ValueError", "The option 'ociParManifest' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "ociParManifest": False })
...
EXPECT_FAIL("ValueError", "The option 'ociParManifest' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "ociParManifest": True, "ociParExpireTime": "2021-01-01" })
...
EXPECT_FAIL("ValueError", "The option 'ociParExpireTime' cannot be used when the value of 'ociParManifest' option is not True.", [types_schema], test_output_relative, { "ociParExpireTime": "2021-01-01" })
EXPECT_FAIL("ValueError", "The option 'ociParExpireTime' cannot be used when the value of 'ociParManifest' option is not True.", [types_schema], test_output_relative, { "osBucketName": "bucket", "ociParExpireTime": "2021-01-01" })
EXPECT_FAIL("ValueError", "The option 'ociParExpireTime' cannot be used when the value of 'ociParManifest' option is not True.", [types_schema], test_output_relative, { "osBucketName": "bucket", "ociParManifest": False, "ociParExpireTime": "2021-01-01" })
...
EXPECT_FAIL("ValueError", "Invalid options: dummy", [types_schema], test_output_relative, { "dummy": "fails" })
EXPECT_FAIL("ValueError", "Invalid options: users", [types_schema], test_output_relative, { "users": "fails" })
EXPECT_FAIL("ValueError", "Invalid options: excludeUsers", [types_schema], test_output_relative, { "excludeUsers": "fails" })
EXPECT_FAIL("ValueError", "Invalid options: includeUsers", [types_schema], test_output_relative, { "includeUsers": "fails" })
EXPECT_FAIL("ValueError", "Invalid options: indexColumn", [types_schema], test_output_relative, { "indexColumn": "dummy" })
EXPECT_FAIL("ValueError", "Invalid options: fieldsTerminatedBy", [types_schema], test_output_relative, { "fieldsTerminatedBy": "dummy" })
EXPECT_FAIL("ValueError", "Invalid options: fieldsEnclosedBy", [types_schema], test_output_relative, { "fieldsEnclosedBy": "dummy" })
EXPECT_FAIL("ValueError", "Invalid options: fieldsEscapedBy", [types_schema], test_output_relative, { "fieldsEscapedBy": "dummy" })
EXPECT_FAIL("ValueError", "Invalid options: fieldsOptionallyEnclosed", [types_schema], test_output_relative, { "fieldsOptionallyEnclosed": "dummy" })
EXPECT_FAIL("ValueError", "Invalid options: linesTerminatedBy", [types_schema], test_output_relative, { "linesTerminatedBy": "dummy" })
EXPECT_FAIL("ValueError", "Invalid options: dialect", [types_schema], test_output_relative, { "dialect": "dummy" })
EXPECT_FAIL("ValueError", "Invalid options: excludeSchemas", [types_schema], test_output_relative, { "excludeSchemas": "dummy" })
...
# WL13807-TSFR4_25
EXPECT_FAIL("ValueError", "The 'ddlOnly' and 'dataOnly' options cannot be both set to true.", [types_schema], test_output_relative, { "ddlOnly": True, "dataOnly": True })
...
# WL13807-TSFR4_36
EXPECT_FAIL("ValueError", "The table to be excluded must be in the following form: schema.table, with optional backtick quotes, wrong value: 'dummy'.", [types_schema], test_output_relative, { "excludeTables": [ "dummy" ] })
EXPECT_FAIL("ValueError", "Failed to parse table to be excluded 'dummy.dummy.dummy': Invalid object name, expected end of name, but got: '.'", [types_schema], test_output_relative, { "excludeTables": [ "dummy.dummy.dummy" ] })
EXPECT_FAIL("ValueError", "Failed to parse table to be excluded '@.dummy': Invalid character in identifier", [types_schema], test_output_relative, { "excludeTables": [ "@.dummy" ] })
EXPECT_FAIL("ValueError", "Failed to parse table to be excluded 'dummy.@': Invalid character in identifier", [types_schema], test_output_relative, { "excludeTables": [ "dummy.@" ] })
EXPECT_FAIL("ValueError", "Failed to parse table to be excluded '@.@': Invalid character in identifier", [types_schema], test_output_relative, { "excludeTables": [ "@.@" ] })
EXPECT_FAIL("ValueError", "Failed to parse table to be excluded '1.dummy': Invalid identifier: identifiers may begin with a digit but unless quoted may not consist solely of digits.", [types_schema], test_output_relative, { "excludeTables": [ "1.dummy" ] })
EXPECT_FAIL("ValueError", "Failed to parse table to be excluded 'dummy.1': Invalid identifier: identifiers may begin with a digit but unless quoted may not consist solely of digits.", [types_schema], test_output_relative, { "excludeTables": [ "dummy.1" ] })
EXPECT_FAIL("ValueError", "Failed to parse table to be excluded '2.1': Invalid identifier: identifiers may begin with a digit but unless quoted may not consist solely of digits.", [types_schema], test_output_relative, { "excludeTables": [ "2.1" ] })
...
EXPECT_FAIL("ValueError", "Unknown compatibility option: dummy", [incompatible_schema], test_output_relative, { "compatibility": [ "dummy" ] })
EXPECT_FAIL("ValueError", "Unknown compatibility option: ", [incompatible_schema], test_output_relative, { "compatibility": [ "" ] })
