...
def TEST_BOOL_OPTION(option):
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Bool, but is Null".format(option), [types_schema], test_output_relative, { option: None })
    EXPECT_FAIL("TypeError", "Option '{0}' Bool expected, but value is String".format(option), [types_schema], test_output_relative, { option: "dummy" })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Bool, but is Array".format(option), [types_schema], test_output_relative, { option: [] })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Bool, but is Map".format(option), [types_schema], test_output_relative, { option: {} })

def TEST_STRING_OPTION(option):
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type String, but is Null".format(option), [types_schema], test_output_relative, { option: None })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type String, but is Integer".format(option), [types_schema], test_output_relative, { option: 5 })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type String, but is Integer".format(option), [types_schema], test_output_relative, { option: -5 })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type String, but is Array".format(option), [types_schema], test_output_relative, { option: [] })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type String, but is Map".format(option), [types_schema], test_output_relative, { option: {} })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type String, but is Bool".format(option), [types_schema], test_output_relative, { option: False })

def TEST_UINT_OPTION(option):
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type UInteger, but is Null".format(option), [types_schema], test_output_relative, { option: None })
    EXPECT_FAIL("TypeError", "Option '{0}' UInteger expected, but Integer value is out of range".format(option), [types_schema], test_output_relative, { option: -5 })
    EXPECT_FAIL("TypeError", "Option '{0}' UInteger expected, but value is String".format(option), [types_schema], test_output_relative, { option: "dummy" })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type UInteger, but is Array".format(option), [types_schema], test_output_relative, { option: [] })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type UInteger, but is Map".format(option), [types_schema], test_output_relative, { option: {} })

def TEST_ARRAY_OF_STRINGS_OPTION(option):
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Array, but is Integer".format(option), [types_schema], test_output_relative, { option: 5 })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Array, but is Integer".format(option), [types_schema], test_output_relative, { option: -5 })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Array, but is String".format(option), [types_schema], test_output_relative, { option: "dummy" })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Array, but is Map".format(option), [types_schema], test_output_relative, { option: {} })
    EXPECT_FAIL("TypeError", "Option '{0}' is expected to be of type Array, but is Bool".format(option), [types_schema], test_output_relative, { option: False })
    EXPECT_FAIL("TypeError", "Option '{0}' String expected, but value is Null".format(option), [types_schema], test_output_relative, { option: [ None ] })
    EXPECT_FAIL("TypeError", "Option '{0}' String expected, but value is Integer".format(option), [types_schema], test_output_relative, { option: [ 5 ] })
    EXPECT_FAIL("TypeError", "Option '{0}' String expected, but value is Integer".format(option), [types_schema], test_output_relative, { option: [ -5 ] })
    EXPECT_FAIL("TypeError", "Option '{0}' String expected, but value is Map".format(option), [types_schema], test_output_relative, { option: [ {} ] })
    EXPECT_FAIL("TypeError", "Option '{0}' String expected, but value is Bool".format(option), [types_schema], test_output_relative, { option: [ False ] })
...
#@<> first parameter
EXPECT_FAIL("ArgumentError", "Argument #1 is expected to be an array of strings", None, test_output_relative)
EXPECT_FAIL("ArgumentError", "Argument #1 is expected to be an array", 1, test_output_relative)
EXPECT_FAIL("ArgumentError", "Argument #1 is expected to be an array", types_schema, test_output_relative)
EXPECT_FAIL("ArgumentError", "Argument #1 is expected to be an array", {}, test_output_relative)
EXPECT_FAIL("ArgumentError", "Argument #1 is expected to be an array of strings", [1], test_output_relative)

#@<> WL13807-TSFR_2_3_3 - second parameter
EXPECT_FAIL("ArgumentError", "Argument #2 is expected to be a string", [types_schema], None)
EXPECT_FAIL("ArgumentError", "Argument #2 is expected to be a string", [types_schema], 1)
EXPECT_FAIL("ArgumentError", "Argument #2 is expected to be a string", [types_schema], [])
EXPECT_FAIL("ArgumentError", "Argument #2 is expected to be a string", [types_schema], {})
EXPECT_FAIL("ArgumentError", "Argument #2 is expected to be a string", [types_schema], True)

#@<> WL13807-TSFR_3_1 - third parameter
EXPECT_FAIL("ArgumentError", "Argument #3 is expected to be a map", [types_schema], test_output_relative, 1)
EXPECT_FAIL("ArgumentError", "Argument #3 is expected to be a map", [types_schema], test_output_relative, "string")
EXPECT_FAIL("ArgumentError", "Argument #3 is expected to be a map", [types_schema], test_output_relative, [])

#@<> WL13807-TSFR_2_2 - Call dumpSchemas(): giving less parameters than allowed, giving more parameters than allowed
EXPECT_THROWS(lambda: util.dump_schemas(), "ArgumentError: Util.dump_schemas: Invalid number of arguments, expected 2 to 3 but got 0")
EXPECT_THROWS(lambda: util.dump_schemas(["mysql"], test_output_relative, {}, None), "ArgumentError: Util.dump_schemas: Invalid number of arguments, expected 2 to 3 but got 4")

#@<> WL13807-FR2.1 - If the `schemas` parameter is an empty list, an exception must be thrown.
EXPECT_FAIL("ArgumentError", "The 'schemas' parameter cannot be an empty list.", [], test_output_relative)

#@<> WL13807-FR2.2 - If the `schemas` parameter contains a name of the schema that does not exist, an exception must be thrown.
EXPECT_FAIL("ArgumentError", "Following schemas were not found in the database: 'mysqlmysql'", ["mysqlmysql"], test_output_relative)
EXPECT_FAIL("ArgumentError", "Following schemas were not found in the database: 'mysqlmysql'", [types_schema, "mysqlmysql"], test_output_relative)
EXPECT_FAIL("ArgumentError", "Following schemas were not found in the database: 'mysqlmysql'", ["mysqlmysql", types_schema], test_output_relative)
# WL13807-TSFR_2_1_1
EXPECT_FAIL("ArgumentError", "Following schemas were not found in the database: 'dummy', 'mysqlmysql'", ["mysqlmysql", types_schema, "dummy"], test_output_relative)
# WL13807-TSFR_2_1_2
EXPECT_FAIL("ArgumentError", "Following schemas were not found in the database: ''", [""], test_output_relative)
...
EXPECT_THROWS(lambda: util.dump_schemas([types_schema], test_output_relative, { "showProgress": False }), "ArgumentError: Util.dump_schemas: Cannot proceed with the dump, the specified directory '{0}' already exists at the target location {1} and is not empty.".format(test_output_relative, absolute_path_for_output(test_output_absolute)))
...
EXPECT_FAIL("ArgumentError", 'Wrong input number "xyz"', [types_schema], test_output_absolute, { "bytesPerChunk": "xyz" })
EXPECT_FAIL("ArgumentError", 'Wrong input number "1xyz"', [types_schema], test_output_absolute, { "bytesPerChunk": "1xyz" })
EXPECT_FAIL("ArgumentError", 'Wrong input number "2Mhz"', [types_schema], test_output_absolute, { "bytesPerChunk": "2Mhz" })
# WL13807-TSFR_3_532_3
EXPECT_FAIL("ArgumentError", 'Wrong input number "0.1k"', [types_schema], test_output_absolute, { "bytesPerChunk": "0.1k" })
EXPECT_FAIL("ArgumentError", 'Wrong input number "0,3M"', [types_schema], test_output_absolute, { "bytesPerChunk": "0,3M" })
EXPECT_FAIL("ArgumentError", 'Input number "-1G" cannot be negative', [types_schema], test_output_absolute, { "bytesPerChunk": "-1G" })
EXPECT_FAIL("ArgumentError", "The option 'bytesPerChunk' cannot be set to an empty string.", [types_schema], test_output_absolute, { "bytesPerChunk": "" })
# WL13807-TSFR_3_532_2
EXPECT_FAIL("ArgumentError", "The option 'bytesPerChunk' cannot be used if the 'chunking' option is set to false.", [types_schema], test_output_absolute, { "bytesPerChunk": "128k", "chunking": False })
...
EXPECT_FAIL("ArgumentError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "127k" })
EXPECT_FAIL("ArgumentError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "127999" })
EXPECT_FAIL("ArgumentError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "1" })
EXPECT_FAIL("ArgumentError", "The value of 'bytesPerChunk' option must be greater or equal to 128k.", [types_schema], test_output_relative, { "bytesPerChunk": "0" })
EXPECT_FAIL("ArgumentError", 'Input number "-1" cannot be negative', [types_schema], test_output_relative, { "bytesPerChunk": "-1" })
...
# WL13807-TSFR_3_54
EXPECT_FAIL("ArgumentError", "The value of 'threads' option must be greater than 0.", [types_schema], test_output_relative, { "threads": 0 })
...
EXPECT_FAIL("ArgumentError", 'Wrong input number "xyz"', [types_schema], test_output_absolute, { "maxRate": "xyz" })
EXPECT_FAIL("ArgumentError", 'Wrong input number "1xyz"', [types_schema], test_output_absolute, { "maxRate": "1xyz" })
EXPECT_FAIL("ArgumentError", 'Wrong input number "2Mhz"', [types_schema], test_output_absolute, { "maxRate": "2Mhz" })
# WL13807-TSFR_3_552
EXPECT_FAIL("ArgumentError", 'Wrong input number "hello world!"', [types_schema], test_output_absolute, { "maxRate": "hello world!" })
EXPECT_FAIL("ArgumentError", 'Input number "-1" cannot be negative', [types_schema], test_output_absolute, { "maxRate": "-1" })
EXPECT_FAIL("ArgumentError", 'Input number "-1234567890123456" cannot be negative', [types_schema], test_output_absolute, { "maxRate": "-1234567890123456" })
EXPECT_FAIL("ArgumentError", 'Input number "-2K" cannot be negative', [types_schema], test_output_absolute, { "maxRate": "-2K" })
EXPECT_FAIL("ArgumentError", 'Wrong input number "3m"', [types_schema], test_output_absolute, { "maxRate": "3m" })
EXPECT_FAIL("ArgumentError", 'Wrong input number "4g"', [types_schema], test_output_absolute, { "maxRate": "4g" })
...
EXPECT_FAIL("ArgumentError", "The option 'osNamespace' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "osNamespace": "namespace" })
...
# WL13807-TSFR_3_5102
EXPECT_FAIL("ArgumentError", "The option 'ociConfigFile' cannot be used when the value of 'osBucketName' option is not set.", [types_schema], test_output_relative, { "ociConfigFile": "config" })
...
# WL13807-TSFR4_41
EXPECT_FAIL("RuntimeError", "Unknown character set: ''", [types_schema], test_output_relative, { "defaultCharacterSet": "" })
EXPECT_FAIL("RuntimeError", "Unknown character set: 'dummy'", [types_schema], test_output_relative, { "defaultCharacterSet": "dummy" })
...
EXPECT_FAIL("ArgumentError", "Invalid options: fieldsEscapedBy", [types_schema], test_output_relative, { "fieldsEscapedBy": "dummy" })
EXPECT_FAIL("ArgumentError", "Invalid options: fieldsOptionallyEnclosed", [types_schema], test_output_relative, { "fieldsOptionallyEnclosed": "dummy" })
EXPECT_FAIL("ArgumentError", "Invalid options: linesTerminatedBy", [types_schema], test_output_relative, { "linesTerminatedBy": "dummy" })
EXPECT_FAIL("ArgumentError", "Invalid options: dialect", [types_schema], test_output_relative, { "dialect": "dummy" })
EXPECT_FAIL("ArgumentError", "Invalid options: excludeSchemas", [types_schema], test_output_relative, { "excludeSchemas": "dummy" })
...
# WL13807-TSFR4_25
EXPECT_FAIL("ArgumentError", "The 'ddlOnly' and 'dataOnly' options cannot be both set to true.", [types_schema], test_output_relative, { "ddlOnly": True, "dataOnly": True })
...
# WL13807-TSFR4_36
EXPECT_FAIL("ArgumentError", "The table to be excluded must be in the following form: schema.table, with optional backtick quotes, wrong value: 'dummy'.", [types_schema], test_output_relative, { "excludeTables": [ "dummy" ] })
EXPECT_FAIL("ArgumentError", "Failed to parse table to be excluded 'dummy.dummy.dummy': Invalid object name, expected end of name, but got: '.'", [types_schema], test_output_relative, { "excludeTables": [ "dummy.dummy.dummy" ] })
EXPECT_FAIL("ArgumentError", "Failed to parse table to be excluded '@.dummy': Invalid character in identifier", [types_schema], test_output_relative, { "excludeTables": [ "@.dummy" ] })
EXPECT_FAIL("ArgumentError", "Failed to parse table to be excluded 'dummy.@': Invalid character in identifier", [types_schema], test_output_relative, { "excludeTables": [ "dummy.@" ] })
EXPECT_FAIL("ArgumentError", "Failed to parse table to be excluded '@.@': Invalid character in identifier", [types_schema], test_output_relative, { "excludeTables": [ "@.@" ] })
EXPECT_FAIL("ArgumentError", "Failed to parse table to be excluded '1.dummy': Invalid identifier: identifiers may begin with a digit but unless quoted may not consist solely of digits.", [types_schema], test_output_relative, { "excludeTables": [ "1.dummy" ] })
EXPECT_FAIL("ArgumentError", "Failed to parse table to be excluded 'dummy.1': Invalid identifier: identifiers may begin with a digit but unless quoted may not consist solely of digits.", [types_schema], test_output_relative, { "excludeTables": [ "dummy.1" ] })
EXPECT_FAIL("ArgumentError", "Failed to parse table to be excluded '2.1': Invalid identifier: identifiers may begin with a digit but unless quoted may not consist solely of digits.", [types_schema], test_output_relative, { "excludeTables": [ "2.1" ] })
...
EXPECT_FAIL("ArgumentError", "Unknown compatibility option: dummy", [incompatible_schema], test_output_relative, { "compatibility": [ "dummy" ] })
EXPECT_FAIL("ArgumentError", "Unknown compatibility option: ", [incompatible_schema], test_output_relative, { "compatibility": [ "" ] })
