...
# WL13807-FR2.3 - The `outputUrl` parameter must be handled the same as specified in WL#13804, FR4, FR4.1 - FR4.6.
...
EXPECT_THROWS(lambda: util.dump_schemas([types_schema], test_output_relative, { "showProgress": False }), "ArgumentError: Util.dump_schemas: Cannot proceed with the dump, '{0}' already exists at the target location {1}.".format(test_output_relative, absolute_path_for_output(test_output_absolute)))
