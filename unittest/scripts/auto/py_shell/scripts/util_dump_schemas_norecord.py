...
EXPECT_FAIL("ValueError", "Argument #3: Invalid value of 'ociAuth' option, expected one of: api_key, instance_principal, resource_principal, security_token, but got: unknown.", [types_schema], test_output_relative, { "osBucketName": "bucket", "ociAuth": "unknown" })
