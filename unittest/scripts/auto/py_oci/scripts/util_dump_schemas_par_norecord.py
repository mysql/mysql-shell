...
EXPECT_THROWS(lambda:util.dump_schemas(["sample"], prefix, {"osBucketName":k_bucket_name, "osNamespace": OS_NAMESPACE, "ociConfigFile":oci_config_file, "ociParManifest": True, "ociParExpireTime":"InvalidValue"}),
...
prepare_empty_bucket(k_bucket_name, OS_NAMESPACE)
util.dump_schemas(["sample"], prefix, {"osBucketName":k_bucket_name, "osNamespace": OS_NAMESPACE, "ociConfigFile":oci_config_file, "ocimds": True, "compatibility":["strip_restricted_grants"]})
...
prepare_empty_bucket(k_bucket_name, OS_NAMESPACE)
util.dump_schemas(["sample"], prefix, {"osBucketName":k_bucket_name, "osNamespace": OS_NAMESPACE, "ociConfigFile":oci_config_file, "ociParManifest": True})
validate_full_dump(OS_NAMESPACE, k_bucket_name, prefix, today_plus_days(7))
...
util.dump_schemas(["sample"], prefix, {"osBucketName":k_bucket_name, "osNamespace": OS_NAMESPACE, "ociConfigFile":oci_config_file, "ociParManifest": True, "ociParExpireTime":tomorrow})
validate_full_dump(OS_NAMESPACE, k_bucket_name, prefix, tomorrow)

#@<> WL14154-TSFR2_8
prepare_empty_bucket(k_bucket_name, OS_NAMESPACE)
util.dump_schemas(["sample"], prefix, {"osBucketName":k_bucket_name, "osNamespace": OS_NAMESPACE, "ociConfigFile":oci_config_file, "ocimds": True, "compatibility":["strip_restricted_grants"], "ociParManifest": False})
...
util.dump_schemas(["sample"], prefix, {"osBucketName":k_bucket_name, "osNamespace": OS_NAMESPACE, "ociConfigFile":oci_config_file, "ocimds": True, "compatibility":["strip_restricted_grants"], "ociParExpireTime": expire_time})
...
prepare_empty_bucket(k_bucket_name, OS_NAMESPACE)
EXPECT_THROWS(lambda:util.dump_schemas(["sample"], prefix, {"osBucketName":k_bucket_name, "osNamespace": OS_NAMESPACE, "ociConfigFile":oci_config_file, "ocimds": True, "compatibility":["strip_restricted_grants"], "ociParManifest": False, "ociParExpireTime":today_plus_days(1, RFC3339)}),
