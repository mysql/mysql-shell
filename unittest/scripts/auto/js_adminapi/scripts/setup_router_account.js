...
EXPECT_THROWS_TYPE(function(){c.setupRouterAccount("%", {password: "foo"})}, "Cluster.setupRouterAccount: " + __endpoint1 + ": Your password does not satisfy the current policy requirements", "MYSQLSH");
