...
EXPECT_THROWS_TYPE(function(){c.setupAdminAccount("%", {password: "foo"})}, "Cluster.setupAdminAccount: " + __endpoint1 + ": Your password does not satisfy the current policy requirements", "RuntimeError");
