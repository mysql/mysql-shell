...
NOTE: Installed metadata at '<<<hostname>>>:<<<__mysql_sandbox_port1>>>' is up to date (version 2.4.0).
...
Please select an option: Unregistering a Router implies it will not be used in the Cluster, do you want to continue? [y/N]: Upgrading metadata at '<<<hostname>>>:<<<__mysql_sandbox_port1>>>' from version 1.0.1 to version 2.4.0.
Upgrade will require 5 steps
Creating backup of the metadata schema...
Step 1 of 5: upgrading from 1.0.1 to 2.0.0...
Step 2 of 5: upgrading from 2.0.0 to 2.1.0...
...
//@<OUT> Test Migration from 1.0.1 to 2.4.0
Metadata Schema Upgrade
