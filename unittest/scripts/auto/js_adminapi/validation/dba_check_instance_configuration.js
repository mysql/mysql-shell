...
WARNING: The instance '<<<hostname>>>:<<<__mysql_sandbox_port2>>>' cannot be added to an InnoDB cluster because it has the asynchronous (master-slave) replication configured and running. To add to it a cluster please stop the slave threads by executing the query: 'STOP SLAVE;'
