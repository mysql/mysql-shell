...
global_options = cs.routerOptions()["configuration"]["routing_rules"]
EXPECT_EQ(global_options["target_cluster"], "primary")
EXPECT_EQ(cs.routerOptions({"extended": 2})["routers"]["RoutERHosT1::system"]["configuration"]["routing_rules"]["target_cluster"], global_options["target_cluster"]);
EXPECT_NO_THROWS(function() { cs.setRoutingOption("routerhost1::system", "target_cluster", "cluster"); });
EXPECT_NE(cs.routerOptions({"extended": 2})["routers"]["RoutERHosT1::system"]["configuration"]["routing_rules"]["target_cluster"], global_options["target_cluster"]);
