...
EXPECT_THROWS_TYPE(function(){cs.setupRouterAccount("%", {password: "foo"})}, __endpoint1 + ": Your password does not satisfy the current policy requirements", "MYSQLSH");
...
cs.setupRouterAccount("default_hostname", {password: "fooo"});
...
cs.setupRouterAccount("specific_host@198.51.100.0/255.255.255.0", {password: "fooo"});
...
cs.setupRouterAccount("specific_host@198.51.100.0/255.255.255.0", {password: "fooo", update:false});
...
cs.setupRouterAccount("specific_host@198.51.100.0/255.255.255.0", {update:true});
...
// The operation should add missing privileges to existing accounts if update option is used
cs.setupRouterAccount("specific_host@198.51.100.0/255.255.255.0", {password: "foo2", update:true});
...
cs.setupRouterAccount("password_test@%", {password: "1234"});
session.close();
...
cs.setupRouterAccount("dryruntest", {password: "fooo", dryRun:true});
// account not created
EXPECT_EQ(0, count_users_like(session1, "dryruntest", "%"));

//@WL#13536 TSFR5_6 Validate that trying to upgrade a non existing account fails even with dryRun enabled
cs.setupRouterAccount("dryruntest", {update: true, dryRun:true});
...
// create account
cs.setupRouterAccount("dryruntest", {password: "fooo"});
...
cs.setupRouterAccount("interactive_test@%", {interactive: true});
session.close();
...
cs.setupRouterAccount("interactive_test_2@%", {interactive: false});
...
cs.setupAdminAccount("almost_admin_user@%", {password: "1111"});
...
cs.setupRouterAccount("missing_privs@%", {password: "plusultra"});
...
EXPECT_THROWS(function(){cs.setupRouterAccount("cert@%", {requireCertIssuer:124})}, "ClusterSet.setupRouterAccount: Argument #2: Option 'requireCertIssuer' is expected to be of type String, but is Integer");
EXPECT_THROWS(function(){cs.setupRouterAccount("cert@%", {requireCertSubject:124})}, "ClusterSet.setupRouterAccount: Argument #2: Option 'requireCertSubject' is expected to be of type String, but is Integer");
EXPECT_THROWS(function(){cs.setupRouterAccount("cert@%", {requireCertIssuer:null})}, "ClusterSet.setupRouterAccount: Argument #2: Option 'requireCertIssuer' is expected to be of type String, but is Null");
EXPECT_THROWS(function(){cs.setupRouterAccount("cert@%", {requireCertSubject:null})}, "ClusterSet.setupRouterAccount: Argument #2: Option 'requireCertSubject' is expected to be of type String, but is Null");

EXPECT_EQ(session.runSql("select * from mysql.user where user='cert'").fetchOne(), null);

// create with password
cs.setupRouterAccount("cert1@%", {requireCertIssuer:"/CN=cert1issuer", requireCertSubject:"/CN=cert1subject", password:"pwd"});
...
cs.setupRouterAccount("cert2@%", {requireCertIssuer:"/CN=cert2issuer", requireCertSubject:"/CN=cert2subject", password:""});
...
// just issuer
cs.setupRouterAccount("cert3@%", {requireCertIssuer:"/CN=cert3issuer", password:""});
...
// just subject
cs.setupRouterAccount("cert4@%", {requireCertSubject:"/CN=cert4subject", password:""});
...
EXPECT_THROWS(function(){cs.setupRouterAccount("test1@%", {passwordExpiration: "bla", password:""});}, "ClusterSet.setupRouterAccount: Argument #2: Option 'passwordExpiration' UInteger, 'NEVER' or 'DEFAULT' expected, but value is 'bla'");
EXPECT_THROWS(function(){cs.setupRouterAccount("test1@%", {passwordExpiration: -1, password:""});}, "ClusterSet.setupRouterAccount: Argument #2: Option 'passwordExpiration' UInteger, 'NEVER' or 'DEFAULT' expected, but value is '-1'");
EXPECT_THROWS(function(){cs.setupRouterAccount("test1@%", {passwordExpiration: 0, password:""});}, "ClusterSet.setupRouterAccount: Argument #2: Option 'passwordExpiration' UInteger, 'NEVER' or 'DEFAULT' expected, but value is '0'");
EXPECT_THROWS(function(){cs.setupRouterAccount("test1@%", {passwordExpiration: 1.45, password:""});}, "ClusterSet.setupRouterAccount: Argument #2: Option 'passwordExpiration' UInteger, 'NEVER' or 'DEFAULT' expected, but value is Float");
EXPECT_THROWS(function(){cs.setupRouterAccount("test1@%", {passwordExpiration: {}, password:""});}, "ClusterSet.setupRouterAccount: Argument #2: Option 'passwordExpiration' UInteger, 'NEVER' or 'DEFAULT' expected, but value is Map");
...
cs.setupRouterAccount("expire1@%", {passwordExpiration:"never", password:""});
CHECK_LIFETIME("expire1", 0);
cs.setupRouterAccount("expire2@%", {passwordExpiration:"default", password:""});
CHECK_LIFETIME("expire2", null);
cs.setupRouterAccount("expire3@%", {passwordExpiration:null, password:""});
CHECK_LIFETIME("expire3", null);
cs.setupRouterAccount("expire4@%", {passwordExpiration:42, password:""});
CHECK_LIFETIME("expire4", 42);
cs.setupRouterAccount("expire5@%", {passwordExpiration:43, password:""});
