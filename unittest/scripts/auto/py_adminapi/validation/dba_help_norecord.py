...
The following functions are currently supported.
 ...
 - check_instance_configuration        Validates an instance for MySQL InnoDB
                                       Cluster usage.
 - configure_instance                  Validates and configures an instance for
                                       MySQL InnoDB Cluster usage.
 - configure_local_instance            Validates and configures a local
                                       instance for MySQL InnoDB Cluster usage.
...
The options dictionary can contain the next values:
 ...
 - multiMaster: boolean value used to define an InnoDB cluster with multiple
   writable instances.
 - multiPrimary: boolean value used to define an InnoDB cluster with multiple
   writable instances.
...
@warning The multiMaster option will be removed in a future release. Please use
the multiPrimary option instead.

A InnoDB cluster may be setup in two ways:

 - Single Primary: One member of the cluster allows write operations while the
   rest are in read only mode.
 - Multi Primary: All the members in the cluster support both read and write
   operations.
