...
||ReplicaSet.removeInstance: localhost:<<<__mysql_sandbox_port1>>>: Can't connect to MySQL server on 'localhost'
...
||ReplicaSet.addInstance: localhost:<<<__mysql_sandbox_port1>>>: Can't connect to MySQL server on 'localhost'
...
|WARNING: Could not connect to SECONDARY instance: MySQL Error 2003: <<<hostname_ip>>>:<<<__mysql_sandbox_port2>>>: Can't connect to MySQL server on '<<<hostname_ip>>>'|
