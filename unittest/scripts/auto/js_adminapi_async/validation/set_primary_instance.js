...
ReplicaSet.setPrimaryInstance: Argument #1 is expected to be a string (ArgumentError)
ReplicaSet.setPrimaryInstance: Argument #1 is expected to be a string (ArgumentError)
ReplicaSet.setPrimaryInstance: Argument #1 is expected to be a string (ArgumentError)
ReplicaSet.setPrimaryInstance: Argument #2 is expected to be a map (ArgumentError)
