...
|ERROR: Unable to connect to the PRIMARY of the replicaset myrs: MySQL Error 2003: <<<hostname_ip>>>:<<<__mysql_sandbox_port3>>>: Can't connect to MySQL server on '<<<hostname_ip>>>'|
