...
||Argument #1 is expected to be a string (TypeError)
||ReplicaSet name may only contain alphanumeric characters, '_', '-', or '.' and may not start with a number (my cluster) (ArgumentError)
||ReplicaSet name may only contain alphanumeric characters, '_', '-', or '.' and may not start with a number (my:::cluster) (ArgumentError)
||ReplicaSet name may only contain alphanumeric characters, '_', '-', or '.' and may not start with a number (my:::clus/ter) (ArgumentError)
||_1234567890::_1234567890123456789012345678901234567890123456789012345678901234: The ReplicaSet name can not be greater than 63 characters. (ArgumentError)
||ReplicaSet name may only contain alphanumeric characters, '_', '-', or '.' and may not start with a number (::) (ArgumentError)
||An open session is required to perform this operation. (RuntimeError)
...
//@# create with bad configs (should fail) {VER(>=8.3.0) && VER(<9.5.0)}
|NOTE: Some configuration options need to be fixed:|
@+--------------------------+---------------+----------------+--------------------------------------------------+@
@| Variable                 | Current Value | Required Value | Note                                             |@
@+--------------------------+---------------+----------------+--------------------------------------------------+@
...
//@# create with bad configs (should fail) {VER(>=9.5.0)}
|NOTE: Some configuration options need to be fixed:|
@+-----------+---------------+----------------+--------------------------------------------------+@
@| Variable  | Current Value | Required Value | Note                                             |@
@+-----------+---------------+----------------+--------------------------------------------------+@
