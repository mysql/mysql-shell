...
||ReplicaSet.forcePrimaryInstance: localhost:<<<__mysql_sandbox_port3>>>1: Can't connect to MySQL server on 'localhost'
...
|                "connectError": "<<<hostname_ip>>>:<<<__mysql_sandbox_port1>>>: Can't connect to MySQL server on '<<<hostname_ip>>>'|
|                "fenced": null,|
|                "instanceRole": null, |
|                "mode": null, |
|                "status": "INVALIDATED"|
