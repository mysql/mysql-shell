...
EXPECT_THROWS_TYPE(function(){rs.setupAdminAccount("%", {password: "foo"})}, "ReplicaSet.setupAdminAccount: " + __endpoint1 + ": Your password does not satisfy the current policy requirements", "MYSQLSH");
