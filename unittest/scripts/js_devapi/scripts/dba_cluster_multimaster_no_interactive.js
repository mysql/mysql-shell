...
if (__have_ssl)
  ...
  dba.createCluster('devCluster', {multiMaster: true,force: true, memberSsl: false});
...
if (__have_ssl)
  ...
  Cluster.rejoinInstance({dbUser: "root", host: "localhost", port:__mysql_sandbox_port3, memberSsl: false}, "root");
