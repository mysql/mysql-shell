...
cluster.add_instance({'host': 'localhost', 'schema': 'abs', 'user': 'sample', 'auth-method': 56, "memberSslMode": "foo", "ipWhitelist": " "})
...
cluster.remove_instance({'host': 'localhost', 'port': 33060, 'schema': 'abs', 'user': 'sample', 'auth-method': 56})
...
cluster.rejoin_instance({"host": "localhost", "schema": 'abs', "auth-method":56, "memberSslMode": "foo", "ipWhitelist": " "})
