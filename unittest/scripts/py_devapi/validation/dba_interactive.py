...
|Please provide a password for 'root@localhost:<<<__mysql_sandbox_port1>>>':|Dba.validate_instance: The instance 'root@localhost:<<<__mysql_sandbox_port1>>>' is already part of an InnoDB Cluster
