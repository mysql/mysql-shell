...
imported.The following functions are currently supported.
 ...
 - get_classic_session Opens a classic MySQL protocol session to a MySQL
                       server.
 - get_session         Opens a classic MySQL protocol session to a MySQL
                       server.
...
||Invalid number of arguments in mysql.get_classic_session, expected 1 to 2 but got 0
||Invalid number of arguments in mysql.get_classic_session, expected 1 to 2 but got 3
