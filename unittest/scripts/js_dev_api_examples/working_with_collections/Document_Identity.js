...
//@ If the _id is not provided, one will be automatically assigned {VER(>=8.0.5)}
result = myColl.add( { b: 2 } ).execute();
var document = myColl.find("b = 2").execute().fetchOne();
print("Autogenerated Id:", document._id);
