  ...
  namespace proj_parser_tests
  {
    ...
    TEST(Proj_parser_tests, x_test)
    {
      ...
      parse_and_assert_expr("x.a[1][0].c",
        "[19, 22, 19, 8, 76, 9, 8, 76, 9, 22, 19]", "projection ($.x.a[1][0].c as x.a[1][0].c)", true);
      ...
      EXPECT_ANY_THROW(parse_and_assert_expr("foo.bar as a.b.c", "[19, 22, 19, 56, 19, 22, 19, 22, 19]", "projection ($.foo.bar as foo.bar)", true));
