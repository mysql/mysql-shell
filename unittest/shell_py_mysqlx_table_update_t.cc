...
namespace shcore {
  class Shell_py_mysqlx_table_update_tests : public Crud_test_wrapper
  {
  protected:
  ...
  TEST_F(Shell_py_mysqlx_table_update_tests, initialization)
  {
  ...
  TEST_F(Shell_py_mysqlx_table_update_tests, chain_combinations)
  {
    ...
    exec_and_out_equals("crud = table.update()");
  ...
  TEST_F(Shell_py_mysqlx_table_update_tests, update_validations)
  {
    exec_and_out_equals("import mysqlx");
    exec_and_out_equals("session = mysqlx.getNodeSession('" + _uri + "')");
  ...
  TEST_F(Shell_py_mysqlx_table_update_tests, update_execution)
  {
    exec_and_out_equals("import mysqlx");
    exec_and_out_equals("session = mysqlx.getNodeSession('" + _uri + "')");
    exec_and_out_equals("schema = session.getSchema('js_shell_test')");
