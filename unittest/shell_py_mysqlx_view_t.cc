...
namespace shcore {
  class Shell_py_mysqlx_view_tests : public Shell_core_test_wrapper
  {
  protected:
  ...
  // Tests view.getName()
  TEST_F(Shell_py_mysqlx_view_tests, mysqlx_view_get_name)
  {
  ...
  // Tests view.name
  TEST_F(Shell_py_mysqlx_view_tests, mysqlx_view_name)
  {
    exec_and_out_equals("view = session.py_shell_test.view1");
  ...
  TEST_F(Shell_py_mysqlx_view_tests, mysqlx_view_get_session)
  {
  ...
  // Tests view.session
  TEST_F(Shell_py_mysqlx_view_tests, mysqlx_view_session)
  {
    std::string uri = mysh::strip_password(_uri);
  ...
  TEST_F(Shell_py_mysqlx_view_tests, mysqlx_view_get_schema)
  {
    std::string uri = mysh::strip_password(_uri);
    ...
    exec_and_out_equals("print(view_schema)", "<Schema:py_shell_test>");
  }

  // Tests view.schema
  TEST_F(Shell_py_mysqlx_view_tests, mysqlx_view_schema)
  {
    std::string uri = mysh::strip_password(_uri);

    exec_and_out_equals("view = session.py_shell_test.view1");

    exec_and_out_equals("print(view.schema)", "<Schema:py_shell_test>");
  }

  // Tests session.dropView() and view.existInDatabase()
  TEST_F(Shell_py_mysqlx_view_tests, mysqlx_view_drop_exist_in_database)
  {
