...
namespace shcore {
  class Shell_py_mysqlx_table_delete_tests : public Crud_test_wrapper
  {
  protected:
  ...
  TEST_F(Shell_py_mysqlx_table_delete_tests, initialization)
  {
  ...
  TEST_F(Shell_py_mysqlx_table_delete_tests, chain_combinations)
  {
  ...
  TEST_F(Shell_py_mysqlx_table_delete_tests, delete_validations)
  {
    exec_and_out_equals("import mysqlx");
    exec_and_out_equals("session = mysqlx.getNodeSession('" + _uri + "')");
  ...
  TEST_F(Shell_py_mysqlx_table_delete_tests, delete_execution)
  {
    exec_and_out_equals("import mysqlx");
    exec_and_out_equals("session = mysqlx.getNodeSession('" + _uri + "')");
    exec_and_out_equals("schema = session.getSchema('js_shell_test')");
...

    {
      ...
      exec_and_out_equals("result = table.delete().where('gender = \"male\"').limit(2).execute()");
