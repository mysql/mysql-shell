...
namespace shcore {
  class Shell_py_mysqlx_collection_modify_tests : public Crud_test_wrapper
  {
  protected:
  ...
  TEST_F(Shell_py_mysqlx_collection_modify_tests, initialization)
  {
  ...
  TEST_F(Shell_py_mysqlx_collection_modify_tests, chain_combinations)
  {
  ...
  TEST_F(Shell_py_mysqlx_collection_modify_tests, modify_validations)
  {
    exec_and_out_equals("import mysqlx");
    exec_and_out_equals("session = mysqlx.getSession('" + _uri + "')");
  ...
  TEST_F(Shell_py_mysqlx_collection_modify_tests, modify_execution)
  {
    exec_and_out_equals("import mysqlx");
    exec_and_out_equals("session = mysqlx.getNodeSession('" + _uri + "')");
    exec_and_out_equals("schema = session.getSchema('js_shell_test')");
