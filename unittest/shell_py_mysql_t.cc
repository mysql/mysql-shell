...
namespace shcore {
  class Shell_py_mysql_tests : public Shell_core_test_wrapper
  {
  protected:
  ...
  TEST_F(Shell_py_mysql_tests, mysql_exports)
  {
    exec_and_out_equals("import mysql");
    exec_and_out_equals("exports = dir(mysql)");
    exec_and_out_equals("print(len(exports))", "4");

    exec_and_out_equals("print(type(mysql.getClassicSession))", "<type 'builtin_function_or_method'>");
  }

  TEST_F(Shell_py_mysql_tests, mysql_open_session_uri)
  {
    exec_and_out_equals("import mysql");
  ...
  TEST_F(Shell_py_mysql_tests, mysql_open_session_uri_password)
  {
    exec_and_out_equals("import mysql");
    ...
    exec_and_out_equals("session = mysql.getClassicSession('" + _mysql_uri + "', '" + password + "')");
    exec_and_out_equals("print(session)", "<ClassicSession:" + uri + ">");
    exec_and_out_equals("session.close()");
  }

  TEST_F(Shell_py_mysql_tests, mysql_open_session_data)
  {
    exec_and_out_equals("import mysql");
    ...
    exec_and_out_equals("session = mysql.getClassicSession(" + connection_data.str() + ")");
    exec_and_out_equals("print(session)", "<ClassicSession:" + uri.str() + ">");
    exec_and_out_equals("session.close()");
  }

  TEST_F(Shell_py_mysql_tests, mysql_open_session_data_password)
  {
    exec_and_out_equals("import mysql");
    ...
    exec_and_out_equals("session = mysql.getClassicSession(" + connection_data.str() + ", '" + password + "')");
    exec_and_out_equals("print(session)", "<ClassicSession:" + uri.str() + ">");
    exec_and_out_equals("session.close()");
  }
}