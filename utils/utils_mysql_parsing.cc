...
const unsigned char* MySQL_splitter::skip_leading_whitespace(const unsigned char *head, const unsigned char *tail)
{
...
bool MySQL_splitter::is_line_break(const unsigned char *head, const unsigned char *line_break)
{
  if (*line_break == '\0')
    return false;
