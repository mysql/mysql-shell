...
static struct init_message_factory
{
  init_message_factory()
  {
    ...
    server_msgs_by_name["SQL_RESULT_FETCH_DONE_MORE_RESULTSETS"] = std::make_pair(&create<Mysqlx::Sql::CursorFetchDoneMoreResultsets>, Mysqlx::ServerMessages::SQL_RESULT_FETCH_DONE_MORE_RESULTSETS);
    server_msgs_by_id[Mysqlx::ServerMessages::SQL_RESULT_FETCH_DONE_MORE_RESULTSETS] = std::make_pair(&create<Mysqlx::Sql::CursorFetchDoneMoreResultsets>, "SQL_RESULT_FETCH_DONE_MORE_RESULTSETS");
    server_msgs_by_full_name["Mysqlx.Sql.CursorFetchDoneMoreResultsets"] = "SQL_RESULT_FETCH_DONE_MORE_RESULTSETS";
    ...
    server_msgs_by_name["SQL_RESULT_FETCH_DONE"] = std::make_pair(&create<Mysqlx::Sql::CursorFetchDone>, Mysqlx::ServerMessages::SQL_RESULT_FETCH_DONE);
    server_msgs_by_id[Mysqlx::ServerMessages::SQL_RESULT_FETCH_DONE] = std::make_pair(&create<Mysqlx::Sql::CursorFetchDone>, "SQL_RESULT_FETCH_DONE");
    server_msgs_by_full_name["Mysqlx.Sql.CursorFetchDone"] = "SQL_RESULT_FETCH_DONE";
