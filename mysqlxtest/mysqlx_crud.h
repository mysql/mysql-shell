...
namespace mysqlx
{
  ...
  {
  public:
    Schema(std::shared_ptr<Session> conn, const std::string &name);

    TableRef getTable(const std::string &name);
    CollectionRef getCollection(const std::string &name);

    std::shared_ptr<Session> session() const { return m_sess.lock(); }
    const std::string &name() const { return m_name; }
  private:
    std::map<std::string, std::shared_ptr<Table> > m_tables;
    std::map<std::string, std::shared_ptr<Collection> > m_collections;
    std::weak_ptr<Session> m_sess;
    std::string m_name;
  };
  ...
  {
  public:
    Select_Base(std::shared_ptr<Table> table);
    Select_Base(const Select_Base &other);
    Select_Base &operator = (const Select_Base &other);

    virtual std::shared_ptr<Result> execute();
  protected:
    std::shared_ptr<Mysqlx::Crud::Find> m_find;
  };

  class Select_Offset : public Select_Base
  {
  public:
    Select_Offset(std::shared_ptr<Table> table) : Select_Base(table) {}
  ...
  {
  public:
    Select_Limit(std::shared_ptr<Table> table) : Select_Offset(table) {}
  ...
  {
  public:
    Select_OrderBy(std::shared_ptr<Table> table) : Select_Limit(table) {}
  ...
  {
  public:
    Select_Having(std::shared_ptr<Table> table) : Select_OrderBy(table) {}
  ...
  {
  public:
    Select_GroupBy(std::shared_ptr<Table> table) : Select_Having(table) {}
  ...
  {
  public:
    SelectStatement(std::shared_ptr<Table> table, const std::vector<std::string> &fieldList);
  ...
  {
  public:
    Insert_Base(std::shared_ptr<Table> table);
    Insert_Base(const Insert_Base &other);
    Insert_Base &operator = (const Insert_Base &other);

    virtual std::shared_ptr<Result> execute();
  protected:
    std::shared_ptr<Mysqlx::Crud::Insert> m_insert;
  };

  class Insert_Values : public Insert_Base
  {
  public:
    Insert_Values(std::shared_ptr<Table> table);
  ...
  {
  public:
    InsertStatement(std::shared_ptr<Table> coll);
  ...
  {
  public:
    Delete_Base(std::shared_ptr<Table> table);
    Delete_Base(const Delete_Base &other);
    Delete_Base &operator = (const Delete_Base &other);

    virtual std::shared_ptr<Result> execute();
  protected:
    std::shared_ptr<Mysqlx::Crud::Delete> m_delete;
  };

  class Delete_Limit : public Delete_Base
  {
  public:
    Delete_Limit(std::shared_ptr<Table> table) : Delete_Base(table) {}
  ...
  {
  public:
    Delete_OrderBy(std::shared_ptr<Table> table) : Delete_Limit(table) {}
  ...
  {
  public:
    DeleteStatement(std::shared_ptr<Table> table);
  ...
  {
  public:
    Update_Base(std::shared_ptr<Table> table);
    Update_Base(const Update_Base &other);
    Update_Base &operator = (const Update_Base &other);

    virtual std::shared_ptr<Result> execute();
  protected:
    std::shared_ptr<Mysqlx::Crud::Update> m_update;
  };

  class Update_Limit : public Update_Base
  {
  public:
    Update_Limit(std::shared_ptr<Table> table) : Update_Base(table) {}
  ...
  {
  public:
    Update_OrderBy(std::shared_ptr<Table> table) : Update_Limit(table) {}
  ...
  {
  public:
    Update_Where(std::shared_ptr<Table> table) : Update_OrderBy(table) {}
  ...
  {
  public:
    Update_Set(std::shared_ptr<Table> table) : Update_Where(table) {}
  ...
  {
  public:
    UpdateStatement(std::shared_ptr<Table> table);
  ...
  {
  public:
    Table(std::shared_ptr<Schema> schema, const std::string &name);

    std::shared_ptr<Schema> schema() const { return m_schema.lock(); }
    const std::string& name() const { return m_name; }
  ...
  {
  public:
    Collection_Statement(std::shared_ptr<Collection> coll);
    ...
    std::shared_ptr<Collection> collection() const { return m_coll; }

  protected:
    Mysqlx::Datatypes::Scalar* convert_document_value(const DocumentValue& value);

    std::shared_ptr<Collection> m_coll;
  };

  class Find_Base : public Collection_Statement
  {
  public:
    Find_Base(std::shared_ptr<Collection> coll);
  ...
  {
  public:
    Find_Skip(std::shared_ptr<Collection> coll) : Find_Base(coll) {}
  ...
  {
  public:
    Find_Limit(std::shared_ptr<Collection> coll) : Find_Skip(coll) {}
  ...
  {
  public:
    Find_Sort(std::shared_ptr<Collection> coll) : Find_Limit(coll) {}
  ...
  {
  public:
    Find_Having(std::shared_ptr<Collection> coll) : Find_Sort(coll) {}
  ...
  {
  public:
    Find_GroupBy(std::shared_ptr<Collection> coll) : Find_Having(coll) {}
  ...
  {
  public:
    FindStatement(std::shared_ptr<Collection> coll, const std::string &searchCondition);
  ...
  public:
    Add_Base(std::shared_ptr<Collection> coll);
  ...
  {
  public:
    AddStatement(std::shared_ptr<Collection> coll);
    AddStatement(std::shared_ptr<Collection> coll, const Document &doc);
  ...
  {
  public:
    Modify_Base(std::shared_ptr<Collection> coll);
  ...
  {
  public:
    Modify_Limit(std::shared_ptr<Collection> coll) : Modify_Base(coll) {}
  ...
  {
  public:
    Modify_Sort(std::shared_ptr<Collection> coll) : Modify_Limit(coll) {}
  ...
  {
  public:
    Modify_Operation(std::shared_ptr<Collection> coll) : Modify_Sort(coll) {}
  ...
  {
  public:
    ModifyStatement(std::shared_ptr<Collection> coll, const std::string &searchCondition);
  ...
  {
  public:
    Remove_Base(std::shared_ptr<Collection> coll);
  ...
  {
  public:
    Remove_Limit(std::shared_ptr<Collection> coll) : Remove_Base(coll) {}
  ...
  {
  public:
    RemoveStatement(std::shared_ptr<Collection> coll, const std::string &searchCondition);
  ...
  {
  public:
    Collection(std::shared_ptr<Schema> schema, const std::string &name);
