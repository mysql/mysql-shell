...
ClassicView::ClassicView(boost::shared_ptr<ClassicSchema> owner, const std::string &name)
: DatabaseObject(owner->_session.lock(), boost::static_pointer_cast<DatabaseObject>(owner), name)
{
}

ClassicView::ClassicView(boost::shared_ptr<const ClassicSchema> owner, const std::string &name) :
