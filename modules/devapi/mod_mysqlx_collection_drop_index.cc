...
REGISTER_HELP(COLLECTIONDROPINDEX_BRIEF,
              "Handler for index dropping handler on a Collection.");
REGISTER_HELP(COLLECTIONDROPINDEX_DETAIL,
...
CollectionDropIndex::CollectionDropIndex(std::shared_ptr<Collection> owner)
  ...
  add_method("dropIndex", std::bind(&CollectionDropIndex::drop_index, this, _1),
             "data");
  add_method("execute", std::bind(&CollectionDropIndex::execute, this, _1),
             "data");
...
REGISTER_HELP(COLLECTIONDROPINDEX_DROPINDEX_BRIEF,
              "Drops an index from a collection.");
REGISTER_HELP(COLLECTIONDROPINDEX_DROPINDEX_PARAM,
              "@param indexName The name of the index to be dropped.");
REGISTER_HELP(COLLECTIONDROPINDEX_DROPINDEX_RETURNS,
              "@returns This CollectionDropIndex object.");
...
* #### Method Chaining
*
* This function can be invoked only once but the operation will be performed
...
#endif
//@}
shcore::Value CollectionDropIndex::drop_index(
