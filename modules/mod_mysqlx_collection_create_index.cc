...
REGISTER_HELP(COLLECTIONCREATEINDEX_CREATEINDEX_RETURNS, "@returns This CollectionCreateIndex object.");
...
REGISTER_HELP(COLLECTIONCREATEINDEX_EXECUTE_RETURNS, "@returns A Result object.");
