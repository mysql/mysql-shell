...
REGISTER_HELP(BASERESULT_GETWARNINGS_RETURN, "@return A list containing a warning object for each generated warning.");
...
REGISTER_HELP(BASERESULT_GETWARNINGCOUNT_RETURN, "@return the number of warnings.");
...
*
* $(BASERESULT_GETWARNINGCOUNT_RETURN)
*
...
REGISTER_HELP(RESULT_GETAFFECTEDITEMCOUNT_RETURN, "@return the number of affected items.");
...
*
* $(RESULT_GETAFFECTEDITEMCOUNT_RETURN)
*
...
REGISTER_HELP(RESULT_GETAUTOINCREMENTVALUE_RETURN, "@return the integer representing the last insert id");
...
*
* $(RESULT_GETAUTOINCREMENTVALUE_RETURN)
*
...
REGISTER_HELP(RESULT_GETLASTDOCUMENTID_RETURN, "@return the string representing the if of the last inserted document.");
...
*
* $(RESULT_GETLASTDOCUMENTID_RETURN)
*
...
REGISTER_HELP(DOCRESULT_FETCHONE_RETURN, "@return A DbDoc object representing the next Document in the result.");

/**
* $(DOCRESULT_FETCHONE_BRIEF)
*
* $(DOCRESULT_FETCHONE_RETURN)
*/
#if DOXYGEN_JS
...
REGISTER_HELP(DOCRESULT_FETCHALL_RETURN, "@return A List of DbDoc objects.");
...
REGISTER_HELP(ROWRESULT_GETCOLUMNCOUNT_RETURN, "@return the number of columns on the current result.");

/**
* $(ROWRESULT_GETCOLUMNCOUNT_BRIEF)
*
* $(ROWRESULT_GETCOLUMNCOUNT_RETURN)
*/
#if DOXYGEN_JS
...
REGISTER_HELP(ROWRESULT_GETCOLUMNNAMES_RETURN, "@return A list with the names of the columns returned on the active result.");

/**
* $(ROWRESULT_GETCOLUMNNAMES_BRIEF)
*
* $(ROWRESULT_GETCOLUMNNAMES_RETURN)
*/
#if DOXYGEN_JS
...
REGISTER_HELP(ROWRESULT_GETCOLUMNS_RETURN, "@return a list of Column objects containing information about the columns included on the active result.");

/**
* $(ROWRESULT_GETCOLUMNS_BRIEF)
*
* $(ROWRESULT_GETCOLUMNS_RETURN)
*/
#if DOXYGEN_JS
...
REGISTER_HELP(ROWRESULT_FETCHONE_RETURN, "@return A Row object representing the next record on the result.");

/**
* $(ROWRESULT_FETCHONE_BRIEF)
*
* $(ROWRESULT_FETCHONE_RETURN)
*/
#if DOXYGEN_JS
...
REGISTER_HELP(ROWRESULT_FETCHALL_RETURN, "@return A List of DbDoc objects.");

/**
* $(ROWRESULT_FETCHALL_BRIEF)
*
* $(ROWRESULT_FETCHALL_RETURN)
*/
#if DOXYGEN_JS
...
REGISTER_HELP(SQLRESULT_NEXTDATASET_RETURN, "@return A boolean value indicating whether there is another result or not.");

/**
* $(SQLRESULT_NEXTDATASET_BRIEF)
*
* $(SQLRESULT_NEXTDATASET_RETURN)
*/
#if DOXYGEN_JS
