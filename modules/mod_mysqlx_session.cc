...
REGISTER_HELP(XSESSION_DETAIL, "In the future this class will be improved to support interacting not only with MySQL Server "\
...
REGISTER_HELP(BASESESSION_CLOSE_DETAIL, "After closing the session it is still possible to make read only operations "\
...
REGISTER_HELP(BASESESSION_DEFAULTSCHEMA_BRIEF, "Retrieves the Schema configured as default for the session.");
...
REGISTER_HELP(BASESESSION_SETFETCHWARNINGS_BRIEF, "Enables or disables warning generation.");
REGISTER_HELP(BASESESSION_SETFETCHWARNINGS_PARAM, "@param enable Boolean value to enable or disable the warnings.");
REGISTER_HELP(BASESESSION_SETFETCHWARNINGS_DETAIL, "Warnings are generated sometimes when database operations are "\
  "executed, such as SQL statements.");
REGISTER_HELP(BASESESSION_SETFETCHWARNINGS_DETAIL1, "On a Node session the warning generation is disabled by default. "\
  "This function can be used to enable or disable the warning generation based on the received parameter.");
REGISTER_HELP(BASESESSION_SETFETCHWARNINGS_DETAIL2, "When warning generation is enabled, the warnings will be available "\
...
REGISTER_HELP(NODESESSION_PARENTS, "BaseSession,ShellDevelopmentSession,ShellBaseSession");
...
REGISTER_HELP(NODESESSION_SQL_BRIEF, "Creates a SqlExecute object to allow running the received SQL statement on the target MySQL Server.");
REGISTER_HELP(NODESESSION_SQL_PARAM, "@param sql A string containing the SQL statement to be executed.");
REGISTER_HELP(NODESESSION_SQL_RETURN, "@return A SqlExecute object.");
REGISTER_HELP(NODESESSION_SQL_DETAIL, "This method creates an SqlExecute object which is a SQL execution handler.");
REGISTER_HELP(NODESESSION_SQL_DETAIL1, "The SqlExecute class has functions that allow defining the way the statement will be executed "\
"and allows doing parameter binding.");
REGISTER_HELP(NODESESSION_SQL_DETAIL2, "The received SQL is set on the execution handler.");
...
REGISTER_HELP(NODESESSION_CURRENTSCHEMA_BRIEF, "Retrieves the active schema on the session.");
REGISTER_HELP(NODESESSION_GETCURRENTSCHEMA_BRIEF, "Retrieves the active schema on the session.");
REGISTER_HELP(NODESESSION_GETCURRENTSCHEMA_RETURNS, "@return A Schema object if a schema is active on the session.");
...
REGISTER_HELP(NODESESSION_QUOTENAME_RETURNS, "@return A String containing the escaped identifier.");
...
REGISTER_HELP(NODESESSION_SETCURRENTSCHEMA_BRIEF, "Sets the current schema for this session, and returns the schema object for it.");
REGISTER_HELP(NODESESSION_SETCURRENTSCHEMA_PARAM, "@param name the name of the new schema to switch to.");
REGISTER_HELP(NODESESSION_SETCURRENTSCHEMA_RETURNS, "@return the Schema object for the new schema.");
REGISTER_HELP(NODESESSION_SETCURRENTSCHEMA_DETAIL, "At the database level, this is equivalent at issuing the following SQL query:");
REGISTER_HELP(NODESESSION_SETCURRENTSCHEMA_DETAIL1, "  use <new-default-schema>;");
