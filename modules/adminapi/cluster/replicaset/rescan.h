...
#ifndef MODULES_ADMINAPI_CLUSTER_REPLICASET_RESCAN_H_
#define MODULES_ADMINAPI_CLUSTER_REPLICASET_RESCAN_H_
...
#endif  // MODULES_ADMINAPI_CLUSTER_REPLICASET_RESCAN_H_
