...
#ifndef MODULES_ADMINAPI_DBA_REPLICASET_TOPOLOGY_CONFIGURATION_COMMAND_H_
#define MODULES_ADMINAPI_DBA_REPLICASET_TOPOLOGY_CONFIGURATION_COMMAND_H_
...
class Topology_configuration_command : public Command_interface {
 public:
  Topology_configuration_command(std::shared_ptr<Cluster> cluster,
...
#endif  // MODULES_ADMINAPI_DBA_REPLICASET_TOPOLOGY_CONFIGURATION_COMMAND_H_
