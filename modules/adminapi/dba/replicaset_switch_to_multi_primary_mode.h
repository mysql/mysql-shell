...
#ifndef MODULES_ADMINAPI_DBA_REPLICASET_SWITCH_TO_MULTI_PRIMARY_MODE_H_
#define MODULES_ADMINAPI_DBA_REPLICASET_SWITCH_TO_MULTI_PRIMARY_MODE_H_
...
class Switch_to_multi_primary_mode : public Topology_configuration_command {
 public:
  Switch_to_multi_primary_mode(std::shared_ptr<Cluster> cluster,
...
#endif  // MODULES_ADMINAPI_DBA_REPLICASET_SWITCH_TO_MULTI_PRIMARY_MODE_H_
