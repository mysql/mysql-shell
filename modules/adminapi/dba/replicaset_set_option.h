...
#ifndef MODULES_ADMINAPI_DBA_REPLICASET_SET_OPTION_H_
#define MODULES_ADMINAPI_DBA_REPLICASET_SET_OPTION_H_
...
class Replicaset_set_option : public Command_interface {
 public:
  Replicaset_set_option(std::shared_ptr<ReplicaSet> replicaset,
                        const std::string &option, const std::string &value);
  Replicaset_set_option(std::shared_ptr<ReplicaSet> replicaset,
                        const std::string &option, int64_t value);

  ~Replicaset_set_option() override;
...
#endif  // MODULES_ADMINAPI_DBA_REPLICASET_SET_OPTION_H_
