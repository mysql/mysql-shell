...
#ifndef MODULES_ADMINAPI_DBA_REPLICASET_STATUS_H_
#define MODULES_ADMINAPI_DBA_REPLICASET_STATUS_H_
...
class Replicaset_status : public Command_interface {
 public:
  Replicaset_status(std::shared_ptr<ReplicaSet> replicaset,
  ...
  /**
   * Prepare the ReplicaSet status command for execution.
...
#endif  // MODULES_ADMINAPI_DBA_REPLICASET_STATUS_H_
