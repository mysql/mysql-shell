...
#ifndef MODULES_ADMINAPI_DBA_REPLICASET_CHECK_INSTANCE_STATE_H_
#define MODULES_ADMINAPI_DBA_REPLICASET_CHECK_INSTANCE_STATE_H_
...
class Replicaset_check_instance_state : public Command_interface {
 public:
  Replicaset_check_instance_state(
      const ReplicaSet &replicaset,
      const mysqlshdk::db::Connection_options &instance_cnx_opts);

  ~Replicaset_check_instance_state() override;
...
#endif  // MODULES_ADMINAPI_DBA_REPLICASET_CHECK_INSTANCE_STATE_H_
