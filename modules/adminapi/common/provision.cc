...
void set_gr_options(const mysqlshdk::mysql::IInstance &instance,
  ...
  if (!gr_group_name.empty()) {
    // Obtained from the peer instance for join_replicaset().
    ...
    // Set by user or automatically generated by caller of start_replicaset().
...
void start_replicaset(const mysqlshdk::mysql::IInstance &instance,
  ...
  // Start Group Replication (effectively start the replicaset).
