...
if(WIN32)
  ...
  if(NOT BUNDLE_RUNTIME_LIBRARIES)
    ...
    if(MSVC_VERSION GREATER_EQUAL 1930 AND MSVC_VERSION LESS_EQUAL 1940)
  ...
  if(DEFINED ENV{MYSQLSH_CUSTOM_ACTION_DLL})
    set(CPACK_WIX_MYSQLSH_USE_CUSTOM_ACTION "1")
    file(TO_CMAKE_PATH "$ENV{MYSQLSH_CUSTOM_ACTION_DLL}" CPACK_WIX_MYSQLSH_CUSTOM_ACTION_DLL)
  endif()
else()
