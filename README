...
see https://dev.mysql.com/doc/mysql-shell/9.0/en/mysql-innodb-cluster.html

For more information about how to configure and work with InnoDB ReplicaSet see https://dev.mysql.com/doc/mysql-shell/9.0/en/mysql-innodb-replicaset.html

For more information about how to configure and work with InnoDB ClusterSet see https://dev.mysql.com/doc/mysql-shell/9.0/en/innodb-clusterset.html
...
https://dev.mysql.com/doc/dev/mysqlsh-api-javascript/9.0/

For Python API documentation, see:
https://dev.mysql.com/doc/dev/mysqlsh-api-python/9.0/
